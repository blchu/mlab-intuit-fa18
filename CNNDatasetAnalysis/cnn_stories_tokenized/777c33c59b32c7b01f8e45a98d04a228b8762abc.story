-LRB- CNN -RRB- -- A federal judge with a secret court has refused the Obama administration 's request to extend storage of classified National Security Agency telephone surveillance data beyond the current five-year limit .
...
The current case is In re : Application of the FBI for an Order Requiring the Production of Tangible Things -LRB- BR 14-01 -RRB- .
