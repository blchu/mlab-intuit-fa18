-LRB- CNN -RRB- -- Children in Asian countries are on average better problem solvers than their European and American peers , according to a new study by the Organization for Economic Cooperation and Development .
...
`` The first step -- the step computers ca n't do -- involves examining the messy set of facts in a real-world problem to determine which set of algebraic rules to apply , '' it says .
