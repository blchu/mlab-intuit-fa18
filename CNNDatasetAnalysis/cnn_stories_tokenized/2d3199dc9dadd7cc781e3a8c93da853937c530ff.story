-LRB- CNN -RRB- -- Twitter is testing a major profile redesign that 's very reminiscent of Facebook and Google + .
...
Under the header photo in the test is the count for tweets , photos/videos -LRB- a new category called out on the profile -RRB- , who you are following , followers , favorites and lists . Although Petronzio is n't verified on the site , there 's an option for the stream to show `` Tweets '' and `` Tweets and replies '' for every user â $ '' a feature typically reserved for those with the blue check mark .

Other profile pages viewed from an account with the new design are automatically made to look like this too . This means that even if your Twitter page is n't a part of the test , Petronzio can see what yours will look like .

SEE ALSO : Everything you need to know about Bitcoin in 2 minutes

The recommended header photo size in the test version is 1500 x 500 pixels , up from 1252 x 626 in the current design , so users with the new design will want to switch their picture so it does n't look stretched .
