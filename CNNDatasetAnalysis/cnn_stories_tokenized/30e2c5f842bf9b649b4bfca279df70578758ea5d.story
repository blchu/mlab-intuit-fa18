-LRB- CNET -RRB- -- On an otherwise placid holiday weekend , one blog 's commentary on a change to Facebook 's terms of service created a firestorm of banter on the Web : does the social network claim ownership to any user content on the site , even if the user deletes it ?
...
`` We 've also simplified and clarified a lot of information that applies to you , including some things you should n't do when using the site . ''
...
Truth be told , most Facebook users wo n't give a hoot , the same way that the flurry over the Beacon advertising program in late 2007 was fueled by a few vocal privacy advocates while the general population did n't seem to care about it one way or the other .
...
`` The new Terms were clarified to be more consistent with the behavior of the site , '' Schnitt 's statement continued . `` That is , if you send a message to another user -LRB- or post to their wall , etc. . . -RRB- , that content might not be removed by Facebook if you delete your account -LRB- but can be deleted by your friend -RRB- . ''
...
The way they stand now , Facebook 's terms of service claim that the company does not have ownership over content , yet that it does have `` an irrevocable , perpetual , non-exclusive , transferable , fully paid , worldwide license -LRB- to -RRB- ... use , copy , publish , stream , store , retain , publicly perform or display , transmit , scan , reformat , modify , edit , frame , translate , excerpt , adapt , create derivative works , and distribute '' material as long as it does n't violate the privacy preferences set by the user .
