...
But de Icaza says the desktop wars were already lost to OS X by the time the latest shakeups started happening . And he thinks the real reason Linux lost is that developers started defecting to OS X because the developers behind the toolkits used to build graphical Linux applications did n't do a good enough job ensuring backward compatibility between different versions of their APIs . `` For many years , we broke people 's code , '' he says . `` OS X did a much better job of ensuring backward compatibility . ''
...
`` The reason I 'm personally at Mozilla is that I saw a lot of websites that were n't designed with the principles of free software , '' she says . Thanks to AJAX and HTML5 , the web has become the dominant platform for applications she says .
