-LRB- CNET -RRB- -- A post on the Facebook developer blog announces the big application program interface -LRB- API -RRB- update from the social network that was first reported on Sunday night , which it 's calling the Open Stream API .

The `` Open Stream API '' was front-and-center with Facebook 's controversial redesign earlier this year .

It 's the first major implementation of an emerging -LRB- read : brand new -RRB- open standard called Activity Streams , on which Facebook has been collaborating with developers for the past few months .
...
But Facebook is n't the only big social-networking player to be implementing Activity Streams . The emerging standard was behind the upgrades to MySpace 's MySpaceID product that the News Corp.-owned service launched in March at the South by Southwest Interactive Festival .
...
`` It 's getting where we need it to be , which is like e-mail : where you can write a POP client and know -LRB- that -RRB- it works , '' Engel said . `` It 's not even a full standard yet , so it 's sort of exciting to see so many people get behind something so quickly , and it 's definitely indicative of the general momentum of people who are saying we 'd rather work open than work closed . ''
