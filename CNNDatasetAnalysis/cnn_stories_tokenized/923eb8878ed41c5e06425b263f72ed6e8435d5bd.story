-LRB- CNN -RRB- -- On the surface , a fast-growing service called Bit.ly performs a small task : it shortens URLs .
...
With little effort , regular users can see -- in real time -- the number of clicks received by their Bit.ly link , the location of the person clicking , and the service used at the time of the click -LRB- Facebook , Twitter , etc. -RRB- .
...
`` You do n't need a tech team to use Bit.ly , '' said Cohen . `` It 's a tool that 's immediately accessible to regular people . ''

A few months ago , Twitter quietly replaced TinyURL , one of the early shorteners , with Bit.ly as its default . There are now rumors that Twitter will buy Bit.ly outright , but Cohen wo n't comment on rumors .
...
But Bit.ly is perhaps more interesting for where it 's going . About 200 million Bit.ly links are clicked on in a typical week , and the number is growing fast -LRB- it 's doubled over the past few months -RRB- . That kind of volume can yield analysis that 's relevant to the Web at large .
...
Bit.ly is still exploring business models , but one thing it wo n't do , according to Cohen , is inject advertisements when users click on a link .
...
Another company offers a useful browser add-on for Firefox called Hyperwords . It 's added full-URL-reveal to its long list of capabilities , and it works for most -LRB- though not all -RRB- brands of shortened URL .

Bit.ly and others , including tr.im , let outside applications tap their application programming interfaces -LRB- API -RRB- , so one thing they can do is offer full URL preview in their own programs . For instance with TweetDeck , a popular app for organizing tweets , you can see the full URL behind a Bit.ly link .
...
Interestingly , she did n't mind if it was Google doing the tracking . She minded if it was somebody she knew , like a business associate -- even though the data is anonymous . Some things , like the quirks of human psychology , can probably never be addressed .
