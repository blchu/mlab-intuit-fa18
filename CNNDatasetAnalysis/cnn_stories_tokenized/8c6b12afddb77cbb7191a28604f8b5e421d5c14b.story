-LRB- CNN -RRB- -- London City Airport wants to eradicate the many nuisances associated with flying .
...
This streamlined experience is being delivered with the help of a technology known as the Internet of Things -LRB- IoT -RRB- . Essentially , it is an overarching platform that allows a variety of devices or machines to communicate with each other .

This `` machine to machine '' communication -LRB- M2M -RRB- remains in its early stages , but its application is being tested in a number of areas . It is the foundation for `` smart cars '' , vehicles which are tuned in to avoid collision , and `` smart lights '' , which detect when you 've woken up and then turn on .
...
`` There 's no reason you ca n't have an app on your phone tell you the route and the correct exit -LRB- to find your vehicle -RRB- , '' says Daniels .
...
`` They might jam a smart device to make systems not available in the airport , or play with the bar code of flight tickets , so that you can have access to a space you should n't have access to , '' he says , while admitting that these scenarios are extreme .

For Daniels privacy is n't really an issue , as passengers can chose whether or not they `` opt in '' . Furthermore , the technology will actually allow airports to have a more sophisticated security system in place .

`` If there 's suddenly a security issue , and someone is suddenly somewhere they should n't be , the authorities can access the day-to-day information more easily , '' he says .
