-LRB- Mashable -RRB- -- Windows 8 wo n't be ready for consumers until fall , but that 's not stopping hardware makers from fighting to be first in line to build hardware for Microsoft 's new operating system .

Lenovo is planning to be the `` first to market '' with a Windows 8 tablet , The Verge reports .

Citing a `` source , '' the report says Lenovo is planning to be ready to ship the device in October and that it will have an Intel chip , so it clearly wo n't be a Windows-on-ARM device . Other than that , there are n't any details on exactly what the machine will be , although given those basic criteria -LRB- tablet , Intel , Windows 8 -RRB- , there 's at least one suspect : the IdeaPad Yoga .
...
While the new version of Windows has been engineered to be near-identical on both , ARM-based Windows devices are going to be `` end-to-end '' devices -LRB- meaning Windows would come fully integrated -RRB- and have a few special features , like an ultra-low-power mode . However , most legacy apps wo n't work on them .
