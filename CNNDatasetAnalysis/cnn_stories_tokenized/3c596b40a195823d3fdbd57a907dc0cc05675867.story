-LRB- CNN -RRB- -- DARPA , the U.S. Defense Advanced Research Projects Agency , funds some of the world 's most far out , forward-thinking research into new military technology .
...
Tech company iRobot worked with DARPA on its `` ChemBots '' program . The aim was to build soft , flexible robots that could deform their bodies to move through openings smaller than themselves -LRB- e.g. under doors -RRB- to carry out covert tasks .
...
LANdroids -LRB- Local Area Network droids -RRB-
...
The ultimate goal of the Falcon Hypersonic Technology Vehicle 2 -LRB- HTV-2 -RRB- program is to create a vehicle that can fly anywhere in the world in less than an hour -- while enduring temperatures in excess of 1,925 C -LRB- 3,500 F -RRB- .

DARPA has already produced and flown a test HTV-2 -- an unmanned , rocket-launched aircraft that travels at Mach 20 -LRB- about 13,000 miles per hour -RRB- . At that speed a flight between New York City and Los Angeles would take less than 12 minutes .
...
This `` robot ostrich , '' called FastRunner , is a joint project between DARPA , MIT and the Florida Institute for Human and Machine Cognition -LRB- IHMC -RRB- .
...
Six contractors are working on the project , including Lockheed Martin , AAI Corp. and Carnegie Mellon University -LRB- CMU -RRB- .
...
Cognitive Technology Threat Warning System -LRB- CT2WS -RRB-
...
Nano Air Vehicle -LRB- NAV -RRB-

The Nano Air Vehicle -LRB- NAV -RRB- program is developing a tiny , ultra-light air vehicle for indoor and outdoor military missions . The program has already produced an impressive prototype robotic hummingbird , complete with fast-flapping wings that let it hover and fly .
