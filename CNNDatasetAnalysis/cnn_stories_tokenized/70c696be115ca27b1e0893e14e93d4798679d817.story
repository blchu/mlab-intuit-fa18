...
That state court ruling has privacy implications that reach far beyond text messages . It allows police in California to access any data stored on an arrestee 's phone : photos , address book , Web-browsing history , data stored in apps -LRB- including social media apps -RRB- , voicemail messages , search history , chat logs , and more . Also , depending on the use of location-enabled services or apps that store data on the phone , the police might also be able to infer the arrestee 's past whereabouts .
...
What happens next ? Hanni Fakhoury , staff attorney for the Electronic Frontier Foundation -LRB- which has been supporting the California bill , and following this issue nationwide -RRB- expects an increase in law enforcement `` fishing expeditions '' involving cell phones .
