-LRB- CNN -RRB- -- The social networking site Facebook on Monday pulled a third-party application that allows users to create polls after a site member built a poll asking if President Obama should be killed .
...
`` As is usually the case , our vigilant users reported it to us first , '' Facebook spokesman Barry Schnitt told CNN . `` The USSS -LSB- Secret Service -RSB- sent us an e-mail late this morning PDT asking us to take it down . At that point , it had already been removed , and we let them know . ''
