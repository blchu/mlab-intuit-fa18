-LRB- WIRED -RRB- -- A radio without any knobs . A bathroom where a clear display wirelessly streams vital statistics on your health . And a user interface that takes brain waves and translates them into commands for a computer .
...
This implantable antenna uses the 402-405MHz Medical Implant Communications Service -LRB- MICS -RRB- frequency band . Combined with a custom integrated chip or a system on a chip , device makers can use the antenna in pacemakers , neurostimulation devices , and swallowable imaging and diagnostic systems .
