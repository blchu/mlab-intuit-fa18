-LRB- WIRED -RRB- -- Google 's netbook-friendly Chrome OS takes direct aim at Microsoft , whose eight-year-old Windows XP leads the netbook market . But the odds are stacked against Google .

Despite its buzz , the odds are stacked against Google 's Chrome OS becoming a serious rival to Windows .

In competing with Windows , Google Chrome OS will have to deal with many of the same challenges Linux has : compatibility , usability , and unfamiliarity . The record is n't good : In the past year , Linux-based netbooks have rapidly lost market share to Microsoft , as people find that Linux does n't work as expected , may not support the applications or peripherals they 're used to using , and is just plain different .
...
`` Many users found that the universe of applications compatible with Windows was much larger than those with Linux , '' Shim says . `` So when they looked at their Linux netbooks not only did it run non-standard apps but also a graphical interface they were n't familiar with . ''
...
Multimedia compatibility issues in some flavors of Linux helped add to early customer confusion , says Chris Kenyon , director of OEM services at Canonical , which supports Ubuntu . `` Some of those Linux netbooks that did n't have Flash preinstalled or multimedia codecs pre-installed faced lot of problems , '' he says .

Translation : If a customer ca n't watch YouTube on her new netbook , she 's more likely to return the netbook rather than install Adobe 's Flash plugin for Linux .

What Google must do : Google Chrome OS ca n't afford to make those mistakes . Flash support and the ability to play a wide variety of multimedia files will have to be standard . And where popular application support is missing , Google will have to ensure that it provides satisfying alternatives -LRB- such as Google Docs in place of Microsoft Word -RRB- .

Usability

User interface is a big factor for computer buyers . Many netbook buyers are first-time Linux users . And these newbies have often been stumped by the operating system 's unusual interface . Even with very Windows-like and user-friendly Linux distributions , like Ubuntu , they often do n't know how to perform simple system management or hardware configuration tasks . Options for those exist on the OS but new users have to put in the effort to learn , which can be a turnoff . Chrome OS will have to find a way to offer its customers a familiar graphical user interface that makes it easy to do the tasks they have been used to on a Windows operating system .
...
`` iTunes itself does n't work on Ubuntu but you can use emulators , '' says Kenyon . `` It 's something we would like to change . ''
...
So far , Linux vendors have found that difficult to get OEMs completely on board . PC makers do n't want to jeopardize their relationship with Microsoft , which powers the higher-margin products such as desktops and notebooks .
