...
Gabriel Harp , research manager for Technology Horizons at Silicon Valley-based Institute for the Future -LRB- IFTF -RRB- says such moves are important because they allow city planners , decision makers and citizens to come together at an early stage to find solutions at different urban problems .
...
`` Technology -LRB- will -RRB- allow us to return to -LRB- that in -RRB- the future in a way . ''
