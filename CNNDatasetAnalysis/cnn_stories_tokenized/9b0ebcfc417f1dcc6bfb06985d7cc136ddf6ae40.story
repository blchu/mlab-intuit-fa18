-LRB- CNN -RRB- -- Android is finally getting Chromed out .
...
But this has n't been the case . Android users have been forced to use a generic , stock browser -LRB- unceremoniously named `` Browser '' -RRB- that 's inferior to not only Chrome , but also other browsers available in the Android Market . Dolphin , anyone ?

Google had a reason to take its time : It wanted to do Chrome for Android right .

`` We did n't want to just push out Chrome light , '' said Sundar Pichai , senior vice president of Google Chrome , in an interview . `` Our goal was to get all of Chrome onto Android . ''
...
In fact , Chrome actually surpassed Firefox , once the most popular alternative to the dominant Internet Explorer -LRB- which still holds about 50 percent of desktop browser share -RRB- . After Tuesday 's debut for Android devices -- of which there are more than 700,000 activations daily -- Chrome 's adoption numbers will only escalate .

But the Chrome release raises a number of questions about the new browser app , and the relationship that the Android and Chrome teams have with one another . When the Chrome team first announced it was creating a Chrome-based operating system -- later to be known as Chrome OS -- it was difficult to resolve how the software would n't come into conflict with Android . After all , Android is the premier operating system for all things mobile -LRB- smartphones , tablets -RRB- . Except , that is , for Google 's version of the netbook : the Chromebook . So the question is , Which OS owns what ? Is it Chrome for netbooks , and Android for everything else ?
...
While it 's nice to see the two camps playing nicely in Tuesday 's release , it 's not without a caveat . As of Tuesday 's launch , Chrome for Android is only available for smartphones and tablets running Android version 4.0 -LRB- a.k.a. Ice Cream Sandwich -RRB- . At this point , this includes just a handful of phones and tablets . And of course , it 's Chrome `` beta '' for Android , so do n't expect everything to work perfectly .
