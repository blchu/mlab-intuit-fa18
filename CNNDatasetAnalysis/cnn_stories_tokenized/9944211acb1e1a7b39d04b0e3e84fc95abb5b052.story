-LRB- CNN -RRB- -- Bad news : Your Facebook page is likely about to slow down . Good news : The change will help keep online thieves away .
...
Called HTTPS , as opposed to less-secure HTTP , it 's the connection you see on online retail sites when you 're about to enter credit card information or a password . Sometimes a little lock icon appears in the browser window when you 're connected to a site with HTTPS . -LRB- The `` s , '' by the way , stands for `` secure . '' -RRB-
...
The new change is that Facebook is starting make HTTPS the default setting for all its 1 billion-plus users , so people who have n't selected that option soon will get added security -- and , potentially , slower browsing .
...
`` HTTPS is a way for you to exchange information with a web site securely so you do n't have to worry about anyone trying to listen in . ''
