...
Earlier Monday , U.S. Attorney General Eric Holder announced that the men , all members of the People 's Liberation Army -LRB- PLA -RRB- , `` maintained unauthorized access to victim computers to steal information from these entities that would be useful '' to the victims ' competitors in China .
...
`` From WikiLeaks to the -LRB- Edward -RRB- Snowden incident , the U.S. hypocrisy and double standards have been abundantly clear . The Chinese PLA has been a serious victim of this kind of behavior from the U.S. Statistics show that in recent years the PLA 's international internet terminals have suffered a large number of attacks . IP addresses show that a large number of those attacks come from the U.S.
