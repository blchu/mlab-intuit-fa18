-LRB- Wired -RRB- -- The Mac App Store has launched , freshly stocked with over 1,000 OS X applications . The store comes as part of an OS X update , version 10.6.6 , and is a standalone application rather than being yet another add-on to the already creaking and bloated iTunes .

The store works a lot like the iOS App Store we know already : You sign in with your Apple I.D and then you can shop . Buy a Mac app and the payment is charged to your registered credit card account , and the app downloads automatically and is placed in the applications folder , with a convenient shortcut placed in the dock -LRB- the icon actually leaps from the Store window and lands in the dock -- neat -RRB- .
...
There are also free apps -- the slick new Twitter , for example , which is the long awaited v2 .0 of Tweetie for Mac -- as well as some old favorites -LRB- `` Angry Birds '' is quite something on a 27-inch iMac screen -RRB- .
