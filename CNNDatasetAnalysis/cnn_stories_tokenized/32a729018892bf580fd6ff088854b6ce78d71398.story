...
`` Training examples for plans must accommodate the political fallout that occurs if the general public mistakenly believes that a fictional training scenario is actually a real plan , '' the document says . `` Rather than risk such an outcome by teaching our augmentees using the fictional ` Tunisia ' or ` Nigeria ' scenarios used at -LRB- Joint Combined Warfighting School -RRB- , we elected to use a completely impossible scenario that could never be mistaken as a real plan . ''
...
`` Maintain emergency plans to employ nuclear weapons within -LRB- the continental United States -RRB- to eradicate zombie hordes . ''
