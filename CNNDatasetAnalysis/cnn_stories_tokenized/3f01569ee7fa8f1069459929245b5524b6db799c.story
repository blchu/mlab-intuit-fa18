...
The popular third-party app Mailbox used folders and gestures to make sorting through emails easy . That company was snapped up by Dropbox . Inbox seems to be heavily influenced by Mailbox 's time-saving , reminder-centric approach -LRB- not to mention its name -RRB- . It also borrows some neat features from Google Now .
...
Inbox is currently only invite only . It is available as and iOS and Android app , as well as a desktop view -LRB- for Chrome browser users only -RRB- .
