-LRB- CNN -RRB- -- The Raspberry Pi is all the rage for hobbyists in search of cheap , credit card-sized computers that can run a full PC operating system . Arduino boards have been around nearly a decade , meanwhile , powering robots and all sorts of other creative electronics projects .

Now , a project called UDOO -LRB- `` you do '' -RRB- seeks to bring the best elements of Raspberry Pi and Arduino together into a single mini-PC that can run either Android or Linux .
...
UDOO 's designers claim the board will have `` the power of four Raspberry Pis , '' apparently in reference to the quad-core chip -LRB- the Raspberry Pi uses a single-core -RRB- . The UDOO also has twice as much RAM -LRB- 1GB -RRB- and Gigabit Ethernet as opposed to the Pi 's 100 Megabit Ethernet . The Raspberry Pi has the UDOO beat on price , though , with models selling for $ 25 or $ 35 .
