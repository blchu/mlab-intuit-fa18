-LRB- CNN -RRB- -- Right now , it 's nothing more than an empty plot of land , covered by just a few shrubs and the odd Neem tree . But within a few years , these grass plains just outside Accra , Ghana , could be transformed into a fertile breeding ground for world-class innovation .
...
`` What we want to do is to create the environment and the human resource base for the technology industry to be able to use that -LSB- environment -RSB- and tap that opportunity , '' he says . `` That 's what has happened in China , that 's what has happened in other places of the world . ''
