...
RoboSimian software was influenced by programs used to control the Mars rovers . In both cases , the system is designed to let the robots work as autonomously as possible when communication with a human operator is dropped . Spotty communications are common in disaster scenarios -LRB- and on Mars -RRB- .
