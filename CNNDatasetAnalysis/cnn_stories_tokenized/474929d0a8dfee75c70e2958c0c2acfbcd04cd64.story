...
According to Gowdiak , the latest vulnerability is a holdover from a bug -LRB- referred to here as Issue 32 -RRB- that Security Explorations researchers reported to Oracle in late August . Oracle released a patch for the issue in October but it was incomplete , he said in an e-mail to Ars that was later published to the Bugtraq mailing list .
...
Oracle representatives did n't immediately respond to a request for comment . This post will be updated if a reply comes later .
...
People who do n't use Java are encouraged to uninstall it