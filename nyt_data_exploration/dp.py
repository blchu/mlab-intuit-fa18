...
def fitsBounds(full_text_sentences,abstract_tokens,ratio):
    ...
    avg_sentence_length = avg([len(s) for s in full_text_sentences])
        ...
        for filename in os.listdir(filePath):
            ...
            if (abstract and fullText):
                ...
                if (abstract_string and fullText_string):
                    ...
                    # Tokenize the text and seperate into sentences
                    abstract_tokens = textToWords(abstract_string)
                    fullText_tokens = textToWords(fullText_string)

                    abstract_sentences = sentencesFromText(abstract_tokens)
                    fullText_sentences = sentencesFromText(fullText_tokens)
                    ...
                    if(fitsBounds(fullText_sentences,abstract_tokens,ratio)):
                        abstractSentences.append(abstract_sentences)
                        fullTextSentences.append(fullText_sentences)
