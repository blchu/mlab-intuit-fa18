-LRB- CNN -RRB- -- For the second time in just over a week , Facebook has done an about-face on a feature that has bothered some users for a while .
...
They include a new tool that lets app users share their activity directly in Messenger chats -LRB- say , with all your friends who still play `` FarmVille ? '' -RRB- and the ability to add the `` Like '' button , already appearing on more than 10 million Web pages , to mobile apps .
