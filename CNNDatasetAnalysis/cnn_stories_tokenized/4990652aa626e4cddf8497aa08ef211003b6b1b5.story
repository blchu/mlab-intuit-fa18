-LRB- Wired -RRB- -- A year after its release , Google 's open source Android operating system has become a sensation .
...
A slew of problems have made managing Android apps a `` nightmare , '' they say , including three versions of the OS -LRB- Android 1.5 , 1.6 and 2.0 -RRB- , custom firmware on many phones , and hardware differences between different models .
...
`` Apple maintains an iron grip on what they do and there 's an advantage to that , '' says Kelly Schrock , owner of Fognl , which has three apps on the Android market . `` IPhone developers do n't have to worry about fragmentation and creating apps for the iPhone is much easier . ''
...
But it does n't always work , says Fagan . `` In a sense , we are shooting blind with the emulators because we have no idea how it is really working on the device . ''
...
`` That is n't a big deal , '' says Fagan . `` However , when they start changing fundamentally how certain activities are controlled , such as user settings and screen orientation , it creates issues for developers that have built their apps on an out of the box version of the firmware/SDK . ''
...
A one-man band , Schrock says without any employees he ca n't maintain four different app versions .
