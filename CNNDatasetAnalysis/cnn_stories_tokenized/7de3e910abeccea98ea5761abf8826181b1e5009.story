...
And we ca n't quite figure out the use case for this one , but : `` the electronic tattoo can also be applied to an animal as well . ''
...
The latest version rolling out to field testers includes an ear bud , in response to complaints from some that the first version 's bone-conduction sound system did n't work well . It 's not hard to envision the throat tattoo as an eventual answer to that complaint .
