-LRB- CNN -RRB- -- The brain is one of the last great frontiers of science . For all it does for us -- driving our thoughts , actions , perceptions and making us who we are -- we understand very little about how it works , its underlying biochemistry .
...
We then take samples from each of these distinct regions -LRB- more than 1,000 of them -RRB- , purify the RNA -- the signal indicating if a gene is turned on -- and obtain a readout of the level of activity of each gene for each area .
