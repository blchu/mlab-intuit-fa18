-LRB- CNN -RRB- -- The show `` Archer '' has decided to use some levity to deal with a name that is far from funny these days .

The adult animated FX series focuses on operative Sterling Malory Archer -LRB- voiced by actor H. Jon Benjamin -RRB- , who works for the New York-based International Secret Intelligence Service , or ISIS . Given the negative connotation now attached to the name , the Daily Beast reports that it will be phased out when the show returns in January .
