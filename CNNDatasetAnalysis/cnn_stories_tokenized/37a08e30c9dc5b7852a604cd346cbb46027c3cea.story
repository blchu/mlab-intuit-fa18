-LRB- Mashable -RRB- -- Twitter has rolled out an update to its search tool that makes it easier to find new people to follow .
...
Though a relatively small and obvious move , it 's yet another addition to Twitter 's web interface that makes third-party tools for performing the same task a little less relevant -LRB- though the service has also been offering personalized follow suggestions for some time -RRB- .
