-LRB- CNN -RRB- -- The Supreme Court on Monday revisited one of its high-profile precedents in recent years -- its ban on the death penalty for intellectual disability -- the application of which appeared to again divide the bench .
...
The state supreme court said Florida 's law means any capital inmate above that benchmark can not take the next step and present further mitigating evidence to demonstrate his mental capacity lacks culpability for his crimes .
...
`` If a state conditions the opportunity to demonstrate mental retardation on obtained IQ test scores , it can not ignore the measurement error that is inherent in those scores that is a statistical feature of the test instrument itself , '' Waxman told the bench .
...
`` Your rule prevents us from getting a better understanding of whether that IQ score is accurate or not because we can not even reach the adaptive functioning prong '' the clinical diagnosis that typically follows an initial IQ test , added Kennedy . `` You prevent it at the outset . ''
...
A ruling in Hall v. Florida -LRB- 12-10882 -RRB- is expected by June .
