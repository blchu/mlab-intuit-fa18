-LRB- CNN -RRB- -- Last Tuesday Google unveiled its attempt to rival Facebook , a social-networking product called Google + .
...
-LRB- Do you want a Google + invitation ? Sorry , you may have to wait . -RRB-
...
There are main components to the Google + mobile experience are the free Google + Android app -LRB- of course -RRB- , and the mobile web app -LRB- accessible via the mobile browser on most Web-enabled phones -RRB- .
...
Google + users on non-Android phones -- or who ca n't or do n't want to install the app -- currently can use the mobile Web app . Here , functionality varies : Android and iPhone users of the Web app enjoy substantially more functionality than people on BlackBerry , Nokia , or WebOS devices , at least so far .

The Android app is really important , since ArsTechnica rightly observes : `` The success of Google + will partly depend on the quality of the user experience the service offers on mobile devices . Because Google is n't just a Web developer but also major mobile platform vendor through Android , the company has an opportunity to offer deep integration between its new social networking service and the popular smartphone operating system . ''

What I like

Mostly , I like the Google + Android app .

I am able to use all the other core functionality of Google + via the Android app without difficulty . For instance , I can add people to my `` circles '' -LRB- contact groups that I define -RRB- , read my `` stream '' -LRB- the Google + equivalent of a Facebook news feed , or a tweetstream -RRB- , and take and upload photos . So generally , I 'm pretty satisfied with the app .

If you 're uploading mobile photos or video to Google + -LRB- and you can only do this via the Android app so far , which puts iPhone shutterbugs out of luck -RRB- , you might want to peruse your instant upload settings . By default , Google + uploads everything you shoot as soon as you shoot it , to a private album , from which you can selectively share photos . Personally I only want to upload images I wish to share , so I 've turned this option off .
...
With the app installed and activated on my Android phone , now when I 'm using any of the Web browser I have installed on my phone -LRB- even Opera Mini -RRB- , when I find a page I want to share , Google + is listed as one of the many `` share page '' options -LRB- along with Evernote , Gmail , Messages , etc. -RRB-

This is actually easier than sharing links to Google + on my computer . So far as I 've been able to find there 's no Google + bookmarklet or browser toolbar button that 's the equivalent of share on Facebook . I use these kinds of tools all the time for other services in my Web browser . I 'm sure Google + will have one eventually , but right now on my Android phone at least I do n't have to cut-and-paste the link .
...
I was able to use the Android app to initiate a huddle and invite several friends . However , the only person who could actually join the huddle was also using the Android app . All other invitees , who were accessing Google + via a their Web browser -LRB- desktop or mobile -RRB- , would click to accept my invitation -- but then they were inexplicably routed to the main Google mobile info page . Rather frustrating .

Theoretically , Google + users should be able to participate in a huddle via the mobile Web -LRB- although that did n't work for my friends -RRB- , and even non-users should be able to participate via SMS , though that seems sketchy .
...
This is n't exactly intuitive from the user 's perspective , and I hope Google fixes that soon . Help should always be where users expect to find it . Despite how Google has organized this project , users do n't perceive the Google + Android app as a separate service from Google + .
...
• Google 's existing array of hugely popular consumer services -LRB- mail , docs , calendar , etc. -RRB-

• Google + does n't think too far outside the box -- which was the downfall of Google Wave . It emulates the best functionality from existing popular social media services , but offers in many ways , I think a more user-friendly experience .
