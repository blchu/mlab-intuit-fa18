-LRB- CNN -RRB- -- It 's almost that time : the once-a-decade-moment when the U.S. Bureau of the Census tries to determine the population .

Counting more than 300 million residents is a complex and costly operation -LRB- an estimated $ 14 billion -RRB- , but the results yield the basis for how we apportion Congress , distribute more than $ 400 billion in federal funds and understand basic changes to the number and geographic distribution of U.S. residents .
