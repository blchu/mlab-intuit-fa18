-LRB- CNN -RRB- -- Microsoft has announced its Surface tablets , due out late this year , at a time when security is a growing concern for users of mobile devices .

And when most consumers think security , Microsoft probably is n't the first brand to spring to mind .

But are Surface tablets likely to be any more or less secure than the iPad or Android tablets ? That could depend on which Surface model you 're talking about . But in general , these devices probably wo n't pose any significant additional security risks to mobile users .
...
In contrast , the first model of the Surface tablet -LRB- Windows RT only -RRB- will only offer the Metro interface , so it wo n't be able to run the full versions of many desktop apps popular with Windows users , such as Photoshop .
