-LRB- CNN -RRB- -- The video calling service Skype recently made a change to how it routes calls .
...
`` Reportedly , Microsoft is re-engineering these supernodes to make it easier for law enforcement to monitor calls by allowing the supernodes to not only make the introduction but to actually route the voice data of the calls as well , '' Tim Verry , from the website ExtremeTech , wrote last week . -LRB- Supernodes are third-party computers that act as a sort of directory service for routing calls . -RRB-
...
`` As part of our ongoing commitment to continually improve the Skype user experience , we developed supernodes , which can be located on dedicated servers within secure datacenters , '' the statement from Skype says . `` This has not changed the underlying nature of Skype 's peer-to-peer -LRB- P2P -RRB- architecture , in which supernodes simply allow users to find one another -LRB- calls do not pass through supernodes -RRB- .
...
Haas , Skype 's spokesman , wrote that `` it is also important to note that Skype calls DO NOT -LRB- emphasis his -RRB- pass through supernodes -- they act in a directory function only . ''
...
This seems to mean that Skype ca n't intercept calls just because it owns the supernodes now . The spokesman , however , declined to answer follow-up questions on this point .
...
`` If two Skype users are firewalled so that they can only make outbound TCP connections and can not make UDP connections , how do you route a call between those two users ? ''

Eckersley said he ca n't think of an answer , aside from pushing a call through a supernode , which now would be on a Skype - or Microsoft-owned computer .
...
`` As of 2012 we do n't believe the Skype architecture is secure , '' he said . `` There are a lot of people out there , a lot of governments out there , that have the means to break Skype , and this remains true regardless of whatever Microsoft just changed . ''
