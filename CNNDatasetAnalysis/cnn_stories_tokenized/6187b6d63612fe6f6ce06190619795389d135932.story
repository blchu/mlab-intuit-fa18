-LRB- WIRED -RRB- -- Forget relying solely on touch to control your Apple device . On future iPads , you may be able to control your tablet from across the room using 3-D gestures , such as a swirl or swipe of the hand .

As suggested by a newly uncovered Apple patent , you would be able to manipulate and control graphical elements on your display , such as icons , media files , text and images . The gestures themselves could take many forms : geometric shapes -LRB- e.g. , a half-circle or square -RRB- , symbols -LRB- like a check mark or question mark -RRB- , the letters of the alphabet , and other sorts of predetermined patterns .
...
The patent pre-defines a number of gestures , such as ones for facial recognition , a selection gesture and a pointing gesture -LRB- to identify a specific section of an onscreen image -RRB- .
