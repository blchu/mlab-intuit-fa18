-LRB- CNN -RRB- -- Microsoft is taking its last big step before releasing what promises to be a massive overhaul of its Windows operating system -- and , by extension , how almost all devices running it work .
...
The release will mark the first major update of Microsoft 's operating system since Windows 7 was released three years ago . Unlike previous releases that have , essentially , revamped -LRB- or , in at least one case , mercifully killed -RRB- existing features , Microsoft is touting Windows 8 as a radical reimagining of its core product .

Perhaps its most visible difference from previous versions of Windows will be its compatibility with touchscreen technology . That , combined with the system 's ability to connect devices -LRB- say , a PC , a tablet and a Xbox gaming console -RRB- is what Microsoft hopes will renew the enduring Mac vs. PC war on a new front .
...
`` In the changes we 've seen in the Release Preview , this still holds true , '' she added . `` Microsoft is focused on improving and deepening the Metro -LSB- the system 's design language -RSB- experience , where the desktop is only a portion -- or even an afterthought , for some users -- of a larger , app-based system . ''

The company has made something of a ripple with its smartphone system , at least among critics . The recently released Nokia Lumia 900 has been heralded as the best Windows phone ever , although , as of March , only about 4 % of U.S. smartphones ran the company 's operating system . -LRB- For what it 's worth , that 's a month before the Lumia was released . -RRB-
