...
To date , external backers of the two sides have focused on arming their local proxies rather than negotiating . Russia and Iran have reiterated their commitment to the Assad government , both diplomatically and through direct support . Recent reports suggest that the United States has doubled down on funding the rebels with a secret presidential order authorizing military assistance -LRB- stopping short for now of actual `` lethal aid , '' which has been outsourced to Saudi Arabia and Qatar , in coordination with Turkey -RRB- .
...
Much as the Saleh regime was removed from power through pressure from Yemen 's principal supporters -LRB- including the United States -RRB- , Iranian and Russian pressure can succeed where force from hostile outsiders has not . In Yemen , this was achieved because the Saleh regime 's backers managed the transition while assuring their interests were secure . Without similar assurances there is little reason to expect Russian and Iranian support for a post-Assad transition .
