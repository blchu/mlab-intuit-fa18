-LRB- CNET -RRB- -- Republican politicians on Thursday called for a sweeping new federal law that would require all Internet providers and operators of millions of Wi-Fi access points , even hotels , local coffee shops , and home users , to keep records about users for two years to aid police investigations .
...
Translated , the Internet Safety Act applies not just to AT&T , Comcast , Verizon , and so on -- but also to the tens of millions of homes with Wi-Fi access points or wired routers that use the standard method of dynamically assigning temporary addresses . -LRB- That method is called Dynamic Host Configuration Protocol , or DHCP . -RRB-
...
Because Internet addresses remain a relatively scarce commodity , ISPs tend to allocate them to customers from a pool based on whether a computer is in use at the time . -LRB- Two standard techniques used are the Dynamic Host Configuration Protocol and Point-to-Point Protocol over Ethernet . -RRB-
