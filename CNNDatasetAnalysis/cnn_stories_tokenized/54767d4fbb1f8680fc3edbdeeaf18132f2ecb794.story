...
However , there are numerous practical problems in using dogs to detect cancers in a medical setting -LRB- not least training , consistency and identifying exactly which chemicals the dogs are detecting -RRB- , which is why scientists are seeking to harness the potential detection ability of man 's best friend through the development of an `` electronic nose '' capable of making a diagnosis .

` Easily sniffed '

Finnish researchers are using a device that conducts molecular analysis of the atmosphere in the `` headspace '' above urine samples , and tests it for the volatile organic compounds associated with prostate cancer . In a study published earlier this year , the method had a detection rate of 78 % , and a specificity -LRB- the probability of the test being negative when cancer is absent -RRB- of 67 % .
