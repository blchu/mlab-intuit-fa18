-LRB- CNN -RRB- -- For decades -- dating back to the 1980s -- Apple and Adobe Systems have had a deeply troubled relationship . The most recent phase of their ongoing struggle has been over whether Flash -LRB- Adobe 's hugely popular proprietary format for adding animation , video , and interactivity to web pages -RRB- would run on Apple mobile devices .
...
Apple does offer a mobile app that re-encodes YouTube Flash videos to play on the iPhone , but in general Flash elements wo n't play on Apple mobile devices . So Adobe has been trying hard to get Apple to support Flash on the iPhone , iPad and iPod Touch .
...
HTML5 is an emerging web standard that can work with the fully featured browsers available on most mobile devices , including the iPhone and iPad . It allows developers to build mobile web pages that are much more interactive and multimedia-rich . -LRB- Technically , it 's now called just HTML , but most people are still saying `` HTML5 '' to refer to the new capabilities . -RRB-
...
The Washington Post reports that Wallaby -LRB- a program that runs on the Adobe AIR platform , which does work with Apple 's iOS mobile operating system -RRB- `` was tested with iOS 4.2 . The only supported Webkit browsers at this time are Chrome and Safari on OSX , Windows and iOS . ''
...
But in the big picture , if most internet access goes mobile -LRB- as Gartner predicted will happen by 2013 -RRB- , then there might be less and less reason for web developers to use Flash . It could be that HTML5 might become the norm , and Flash might fade into the mists of tech history .
