Farnborough , England -LRB- CNN -RRB- -- Every second year , the small town of Farnborough in South East England plays host to the biggest names of the aviation world . Exhibitors and vistors mingle with the latest technology to hit the skies .

While the economy remains bleak , a smaller number of orders from plane constructors like Airbus and Boeing than previous years is expected . But huge advances have been made in aerospace technology with Virgin Galactic -LRB- showing the SpaceShipTwo for the first time in Europe -RRB- and SpaceX looking to steal the show from other exhibitors .
