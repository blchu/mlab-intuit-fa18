London -LRB- CNN -RRB- -- A designer has come up with a unique and futuristic solution for speeding up rail travel : he does n't want to change the engines , or the tracks -- he wants to get rid of the stations .
...
Instead of using paper tickets to pass through a barrier , passengers would used an RFID -LRB- radio-frequency identification -RRB- system to transfer from tram to train . Similar systems that let passengers scan pre-paid smartcards are already used on many public transport networks .
...
`` This idea is a far-future thought but would n't it be brilliant to just re-evaluate and just re-think the whole process ? '' he says .
