...
Ending attacks on students , teachers and schools requires action at both the national and international levels . We need a shared recognition that such attacks can amount to war crimes and need global attention . Where attacks occur , the United Nations should be allowed access to negotiate with armed groups to end grave violations against children . -LRB- Thailand recently denied the U.N. access to verify the crimes being committed against children in the south . -RRB-
