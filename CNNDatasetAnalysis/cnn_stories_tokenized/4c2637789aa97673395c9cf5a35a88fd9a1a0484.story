-LRB- CNN -RRB- -- Mobile devices are only as good as the networks that serve them . But too often , a mobile user will purchase a new smartphone with a two-year carrier contract , only then to learn that the phone gets lousy reception at home , work or school .
...
The trouble : This is n't always an easy question to answer .
...
According to the Open Signal Maps blog , `` A high -LRB- signal strength -RRB- does not guarantee a good connection . You can be communicating really well with the tower but the tower might be choked up -- it might be dealing with so much network data that you get terrible speeds . ''
...
The coverage maps on the Open Signal Maps site appear to offer data for major and minor carriers in most regions . They do n't offer an iPhone app , because of differences in how the iOS operating system captures signal data . A BlackBerry app is under consideration .
...
Although people who use feature phones -LRB- the next step down from smartphones , used by nearly 75 % of U.S. mobile users -RRB- can not run the apps for these projects , the data on these maps still might be useful for selecting a local carrier .
