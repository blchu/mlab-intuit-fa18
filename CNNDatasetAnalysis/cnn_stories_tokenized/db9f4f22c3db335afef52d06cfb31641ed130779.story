-LRB- CNN -RRB- -- Apple released Mountain Lion to developers last week , a new operating system that will make your desktop computer work more like your phone than ever before .
...
Apple has also unified your messages across your devices : The Message app -LRB- formerly iMessages -RRB- will replace iChat on the Mac .
...
The downside of simplicity ? Simple systems are often less `` open '' and provide less freedom to try new things : Tasks are either easy to complete -LRB- because the developers thought of that use case -RRB- or not possible at all .

Security

Mobile operating systems could potentially be more secure than their desktop counterparts . In particular , if Apple makes the App Store the only way to download apps to your Mac , it would become more difficult for users to install malware -LRB- since Apple manually approves every app in the store -RRB- .
...
With a similar -LRB- or single -RRB- operating system on all your gadgets , syncing apps , contacts and calendars between them all becomes effortless .
