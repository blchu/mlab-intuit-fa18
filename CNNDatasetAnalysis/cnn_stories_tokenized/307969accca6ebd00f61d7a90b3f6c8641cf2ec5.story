-LRB- CNN -RRB- -- In the one-sided battle between pedestrians and the automobile , the first shot was fired in London in 1896 when 44-year-old Bridget Driscoll became what is believed to be the first pedestrian victim of a petrol-driven car .
...
Called Pedestrian SCOOT -LRB- Split Cycle Offset Optimization Technique -RRB- , it is the first of its kind in the world and uses state-of-the-art video cameras to detect how many pedestrians are waiting at crossings .
...
`` What we 're avoiding is the scenario where we do n't have enough time to get everybody on the crossing and then pedestrians have to wait for another cycle of the traffic signals to get across . ''
...
`` During the day there might be a low flow and you do n't want to be fixed with a high crossing time when there 's no one there , '' he said . `` There are technologies out there that can detect whether a pedestrian is waiting , but the technology we use actually quantifies and counts the number of people .
