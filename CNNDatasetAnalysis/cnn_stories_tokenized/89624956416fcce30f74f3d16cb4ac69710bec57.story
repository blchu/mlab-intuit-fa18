...
Prosecutors cast simple Internet commands known to any halfway literate Internet user -LRB- or anyone who used the Internet back in the early '90s -RRB- as clandestine codes used only by hackers to steal data . That Osama bin Laden could download these files off the WikiLeaks website -LRB- along with millions of other people -RRB- became justification for classifying the whistle-blowing as espionage , an act of war . And Manning is just one of a record seven Americans charged with violating the Espionage Act in a single administration .
