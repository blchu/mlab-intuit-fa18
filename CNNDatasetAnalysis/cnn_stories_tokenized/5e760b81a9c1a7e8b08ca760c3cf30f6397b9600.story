-LRB- Ars Technica -RRB- -- Wikipedia 's `` crowdsourced knowledge '' model has created a spectacular resource , but everyone knows the big caveat : If the data 's important , do n't trust the online encyclopedia without verifying it first .

So how well would a similar crowdsourcing model work for a detailed street-level map of the world ?

Several years ago , that question led to the creation of OpenStreetMap.org , a wiki-style world map that anyone can edit . Several friends in the UK got fed up with the government 's stingy approach to data distribution -LRB- Ordnance Survey has crafted ultra-detailed maps of the UK with public funds , but that data must be licensed for private use -RRB- , and decided to do something about it .

The obvious question was `` why bother ? '' Terrific maps from Google , Microsoft , and others already had a significant lead and were often free -LRB- as in beer -RRB- to embed and use . But location services were exploding , and all were premised on mapping data . The lack of any high-quality , worldwide , free , and open-source map remained a problem .
...
Take a look at Germany , for instance , where open mapping has become a craze . The Zoologischer Garten Berlin -LRB- the Berlin Zoo -RRB- exists in Google Maps , of course , but it has little detail -LRB- though it does have satellite maps , which OpenStreetMap lacks -RRB- .
...
CloudMade hopes to profit by offering free access to its platform in exchange for a cut of ad revenue from free applications -LRB- devs can also pay upfront if they want -RRB- .
...
Sadly , the program does n't work well . Crashes were common in our testing , response could be slow , and the interface was non-intuitive . Users have given it a two-star rating . Even the official press release featured a telling quote : `` Although we know we 're not quite ready to challenge the expensive premium navigation solutions , we 'll quickly get there , '' said skobbler co-founder Marcus Thielking .

Such problems can be fixed . But there 's a deeper issue : will consumers trust a mapping program that encourages them to tap a `` ladybug button '' every time they run into a map problem ? -LRB- The button sets a flag in OpenStreetMap that locals can use to investigate and correct errors . -RRB-
