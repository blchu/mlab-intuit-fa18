Hong Kong -LRB- CNN -RRB- -- Security threats from mobile malware are on the rise and nearly 95 % of targets operate on the Android operating system , according to a new report from NQ Mobile .
...
`` The simplest thing we can do is put passwords on our phones . Installing security and encryption solutions -LRB- are another -RRB- way to do it . Also educating our consumers and our enterprise users not to connect and leave open wi-fi connections or Bluetooth connections -- only to connect to trusted sources . A lot of times we 'll connect to anything . ''
