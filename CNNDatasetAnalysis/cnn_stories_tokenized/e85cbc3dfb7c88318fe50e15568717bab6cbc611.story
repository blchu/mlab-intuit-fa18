...
Many popular consumer apps are still are rolled out first for the iPhone . -LRB- Hello , Instagram ? -RRB- That 's because many Android phones are running substantially older versions of Android , which limits which apps they can support . Plus , Android phones come in a dizzying array of sizes , configurations , and capabilities -- compared to a fairly small selection of iPhone models . Also phone manufacturers and wireless carriers tend to customize the Android interface -LRB- in `` flavors '' such as HTC Sense and Motorola Blur -RRB- .
...
Nearly three-fourths of Android app usage came from devices running some version of Android 2.3 `` Gingerbread . '' That 's not the most recent version of Android -LRB- so far 4.0 `` Ice Cream Sandwich '' runs on only a handful of phones and tablets -RRB- , but it 's robust enough to run the vast majority of Android apps well .
