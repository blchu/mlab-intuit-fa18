-LRB- Mashable -RRB- -- Apple is scheduled to host an education-related event on January 19 -- shrouded with a veil of mystery , as always . A new report from Ars Technica says the company is about to unveil a set of tools to create interactive e-books .
...
Apple , who currently supports the ePub 2 e-book standard -LRB- with some additions -RRB- is also expected to announce support for the ePub 3 standard for iBooks .
