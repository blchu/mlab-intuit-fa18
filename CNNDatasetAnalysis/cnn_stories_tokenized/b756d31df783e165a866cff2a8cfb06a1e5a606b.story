...
`` We never thought a video would be watched in numbers greater than a 32-bit integer -LRB- = 2,147,483,647 views -RRB- , but that was before we met PSY , '' wrote Google , which owns YouTube , in a blog post this week . '' ` Gangnam Style ' has been viewed so many times we have to upgrade ! ''

For anyone who does n't have an advanced degree in computing , that basically means YouTube 's view counter was based on a 32-bit integer , a unit of data in computer programming languages , and the number 2,147,483,647 is its maximum positive value .
...
YouTube 's software engineers saw the problem coming and recently updated to a 64-bit view counter across the site , Google spokesman Matt McLernon said . The view counter can now go up to 9 quintillion views -LRB- 9,223,372,036,854,775,808 , to be exact -RRB- , which should hold PSY for a while .
