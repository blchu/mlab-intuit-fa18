-LRB- CNN -RRB- -- Upgrading to the new Windows 8 operating system is not nearly as complicated as it looks , despite Microsoft 's sometimes muddled marketing .
...
Windows 8 is Microsoft 's latest operating system . It features touchscreen capabilities and a drastically different interface , and runs on tablets as well as PCs . It can be controlled entirely by touch -LRB- on compatible devices -RRB- , with a mouse and keyboard , or by any combination of your preferred input options .
