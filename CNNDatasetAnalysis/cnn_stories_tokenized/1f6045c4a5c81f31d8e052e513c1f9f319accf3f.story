-LRB- CNN -RRB- -- Phone and tablet owners used to spend most of their time surfing the Web .
...
This does n't necessarily mean mobile users are spending nearly three hours per day looking at their phones . Flurry 's Web and app statistics came from different sources .
...
`` This drop appears to be driven largely by a decrease in time spent on -LRB- Facebook 's mobile website -RRB- . In June 2011 , the average Facebook user spent over 33 minutes on average per day on the -LRB- mobile -RRB- website . Today , that number is below 24 minutes . ... -LRB- Mobile users -RRB- are increasingly accessing -LRB- Facebook and other -RRB- online services through mobile applications . ''
...
And of course , users must download and install most native mobile apps in order to run them on their device . That 's a considerable hurdle -- only one in four mobile apps really engages mobile users , and 26 % of all apps downloaded are opened only once and then never used again . With HTML5 Web apps , users do n't have to download , install , launch or update anything . It just runs .
