-LRB- Time -RRB- -- Facebook has started to roll out a new version of its Messenger app for Android that only requires a name and a phone number , not an actual Facebook account , to sign up .
...
This news has set the tech world atwitter with proclamations that the new Messenger is an assault on the lowly text message -LRB- including one such proclamation from Facebook itself -RRB- .

It 's a nice thought , at least . Given that a single text to your neighbor can cost more than a data transmission from Mars , who would n't relish the idea of wireless carriers getting their comeuppance ? In reality , though , standard SMS has a lot going for it , and will likely weather all kinds of assaults , especially one from Facebook .
...
In lieu of tighter smartphone integration , Facebook simply has to compete with similar services that are already well-established . As Boy Genius Report points out , competitor WhatsApp is already a Top 5 messaging app in 141 countries and handles 10 billion messages per day . -LRB- Compare that to 7.8 trillion regular text messages sent in 2011 , according to Portio Research , for an average of 21 billion messages per day . -RRB- Competition is good , but in this case it means users will be fragmented across multiple services that ca n't talk to one another .
