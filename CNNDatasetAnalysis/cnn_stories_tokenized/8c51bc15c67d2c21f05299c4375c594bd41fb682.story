-LRB- CNN -RRB- -- Smartphones inch closer to becoming remote controls for your life at next week 's 2013 Consumer Electronics Show in Las Vegas . The annual event is the largest gadget conference in the world , where major technology companies and scrappy startups can show off their latest innovations .
...
Vehicles are connecting to the Internet to improve navigation , better monitor a car 's performance and alert the driver to maintenance needs . They are also taking a cue from -LRB- and synching with -RRB- smartphones . Cars will continue to integrate apps , voice control and entertainment into the dash , some even running on the Android operating system .
