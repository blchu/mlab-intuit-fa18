-LRB- CNN -RRB- -- It depends on mind-bending physics and ultra-cold temperatures but quantum computing could bring about a new era in processing power that promises to revolutionize everything from artificial intelligence to high finance .
...
`` Compared to the speed we moved from valves to transistors to integrated silicon chips , progress on quantum computers has been very slow , '' wrote Bentley , in an email . `` It 's a much harder problem using mind-bending physics that we do n't fully understand . So it may take a few billions of dollars from Google and a few decades before we really see quantum computers . ''
...
`` It -LRB- quantum computing -RRB- will be another tool to help solve very challenging , very hard problems , '' he said .
