-LRB- CNN -RRB- -- Lytro cameras , which let you take a photo and refocus anywhere after it 's taken , are getting two much-requested new features : Instagram-like filters and the ability to bring the entire image , not just one section , into focus .
...
For one test photo , Eric Cheng , Lytro 's director of photography and a former underwater photographer , filled a glass Christmas ornament with paint and shot a pellet through it , capturing the explosion as it happened -LRB- click and drag the image to the left to see the effect -RRB- .
...
For example , the Glass filter -LRB- below -RRB- throws up a pane of frosted glass between the foreground and the background . Click around to refocus , and it will move accordingly . Carnival distorts the photo like a funhouse mirror , undulating in different directions depending on where you focus .
...
Lytro is not sharing any sales numbers or statistics but says the camera has mostly been a hit with amateur photography enthusiasts . Enterprising customers have found some creative uses . Food bloggers are snapping interactive shots of their meals -LRB- the ability to make a bowl of ramen jiggle in 3-D could be an amazing or gross addition -RRB- . An artist who makes miniature figures uses it to document her work . Bug lovers everywhere like its impressive macro photography abilities .
...
The company has also released a handful of accessories , cases and a tripod mount . There are new Lytro body colors -LRB- hot pink and forest green -RRB- , but other than that , the hardware is the exact same camera that started shipping at the start of the year . The prices have also stayed the same : $ 399 for the 8GB camera and $ 499 for the 16GB version .
