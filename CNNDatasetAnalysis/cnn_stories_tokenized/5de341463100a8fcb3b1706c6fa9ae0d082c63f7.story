-LRB- CNN -RRB- -- Amazon may be coming out with its own smartphone , according to a new report from Bloomberg . The company reportedly is working with Foxconn to develop the hardware , which will likely run Amazon 's version of the Android operating system .
...
There are also some challenges unique to selling smartphones . To build a decent device , Amazon will need the right patents so it does n't end up on the receiving end of costly lawsuits . To that end , the company just hired a new general manager for patent acquisitions and investments , Matt Gordon .
