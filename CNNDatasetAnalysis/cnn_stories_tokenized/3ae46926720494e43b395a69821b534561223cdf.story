...
-LRB- Wired -RRB- -- Many of England 's bridges have become pop culture icons -- London Bridge inspired a song known by kindergarteners the world over and the Tower Bridge has its own Lego set . However , if architect Thomas Heatherwick has his way , the River Thames will soon have a new plant-filled pedestrian crossing inspired in part by Leonardo DiCaprio . -LRB- More on that in a second . -RRB-
