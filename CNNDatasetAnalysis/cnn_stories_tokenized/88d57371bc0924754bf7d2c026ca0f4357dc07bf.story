-LRB- CNN -RRB- A Transportation Security Administration committee concluded that full screening of airport employees nationwide would not lower the overall risk to the public , according to a report released Monday .
...
Specifically , the TSA report said employee vetting should be strengthened by `` updating the list of disqualifying criminal offenses , instituting continuous activity monitoring through the inclusion of additional Federal Bureau of Investigation -LRB- FBI -RRB- and DHS data sources , and maintaining a national database of airport employees whose credentials have been revoked for cause . ''
