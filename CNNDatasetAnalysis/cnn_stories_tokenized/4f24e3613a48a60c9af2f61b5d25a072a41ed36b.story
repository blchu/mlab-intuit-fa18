-LRB- CareerBuilder.com -RRB- -- Do you ever wonder who decided potato chips should come in such a loud , crinkly package ? And why a bag of chips ? Why not a box ? Or a can ? Someone had to decide . Luckily , you can take comfort in knowing that the `` bag of chips '' decision was made by an expert .

Packaging , the art of developing appropriate vehicles for consumer goods to arrive safely at our homes in , is actually a major at multiple colleges in the U.S. And packaging is n't even the strangest college degree out there .
...
`` We have a placement rate in excess of 80 percent immediately upon graduation and -LSB- students -RSB- receive jobs in all facets of the industry due to the nature of the two paths and the broad based knowledge they receive , '' Reed says .

`` Some students start at a racetrack in mid-level management or entry level jobs , others work with the horses either on farms or at the track for a trainer . Still others enter the business in related companies -LSB- like those -RSB- that process wagers or service the industry . ''
...
According to the program 's website , `` Decision Sciences is devoted to the study of quantitative methods used to aid decision making in business environments . Using mathematical models and analytical reasoning , students examine problems ... and learn how to solve these problems by using a number of mathematical techniques , including optimization methods -LRB- linear , integer , nonlinear -RRB- , computer simulation , decision analysis , artificial intelligence and more . ''
