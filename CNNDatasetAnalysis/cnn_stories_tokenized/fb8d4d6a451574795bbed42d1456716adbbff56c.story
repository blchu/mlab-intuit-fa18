-LRB- CNN -RRB- -- This week , a mother called us about her child hospitalized with a Salmonella poisoning from his day care 's chicken lunch . The child 's condition was tenuous , with a blood infection , and treatment was especially challenging as the bacteria was antibiotic resistant .
...
There are other effects of the shutdown that may not be felt for months . During the first six days of the furlough , the CDC shut down its primary systems -LRB- PulseNet and OutbreakNet -RRB- for gathering information from the state public health agencies . Instead , the few staff left at CDC gathered illness data from the states manually .
...
USDA or FDA may issue a public health alert or issue a recall -LRB- or demand that a company recall potentially tainted foods -RRB- , alerting consumers to avoid certain foods and getting them removed from supermarket shelves .

Consumers only see the final action but have little knowledge of the complexity and labor - intensive steps by multiple agencies needed to take it . Yet 10 days ago , Congress sent these public health officials home and left consumers -LRB- and the food industry -RRB- vulnerable to the effects of dangerously contaminated foods .
