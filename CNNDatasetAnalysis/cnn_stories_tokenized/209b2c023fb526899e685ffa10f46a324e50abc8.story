-LRB- CNN -RRB- -- Google this week unveiled its Chrome Web Store , which aims to do for the Web what Apple 's App Store did for mobile devices : It provides a place to explore and `` install '' Web-based applications .
...
In truth , I do n't see the Chrome Web Store gaining steam until we have devices in stores running Chrome OS -- expected sometime next year . Only then will consumers truly grasp this new approach to computing : A super-simple operating system linked to a Web-based app store .
...
Google has essentially launched an app store for devices that do n't exist in public yet