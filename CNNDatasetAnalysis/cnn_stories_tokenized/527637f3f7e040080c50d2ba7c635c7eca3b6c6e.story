-LRB- CNN -RRB- -- The new version of Apple 's mobile operating system , iOS 7 , was released September 18 to mostly positive reviews .
...
On various Apple-oriented message boards , iOS 7 users were complaining that they 'd send a message which appeared to work fine , only to later see the dreaded red exclamation point that means it was n't actually sent .
...
As TIME explains , the brain gets unsettled when the eyes try to focus on images that do n't match up -- for example , when you 're on a rocking ship or moving car and trying to read a stationary item , like a book .
...
The fix ? Again , go to `` Settings '' and `` General , '' but then choose `` Background App Refresh . '' From there , you can choose which apps you 'll allow to run in the background and which you wo n't .
...
When Apple updates its operating system , apps that rely on parts of it -LRB- like Camera -RRB- must update as well . Until they do , they sometimes kick users out . On Apple message boards , users were mentioning apps like Snapchat and Mailbox as frequent offenders .
