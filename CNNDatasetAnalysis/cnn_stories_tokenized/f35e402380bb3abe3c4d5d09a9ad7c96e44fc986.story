-LRB- CNN -RRB- -- Facebook and Google 's privacy issues are well-known .
...
`` Amazon Silk also temporarily logs Web addresses known as uniform resource locators -LRB- ` URLs ' -RRB- for the Web pages it serves and certain identifiers , such as IP or MAC addresses , to troubleshoot and diagnose Amazon Silk technical issues . We generally do not keep this information for longer than 30 days , '' the company says in its privacy statement .

`` Browsing activity is aggregated and is not linked to identity , '' an Amazon spokeswoman said in an e-mail to CNN .

For now , the Silk browser is available only to people who use the Kindle Fire , which does n't go on sale until mid-November . There are rumors , however , that the Amazon browser could make its way onto other mobile devices and possibly desktop machines .

People who worry about the data Amazon Silk may be collecting can turn off the cloud-computing piece of the browser .

If they do n't , every move they make online will be logged by the company for at least a month , Wisniewski said .

Amazon probably wo n't sell that data to advertisers , he said , but the fact that the company keeps a log of Internet use is scary for consumers , because that data could be hacked from Amazon 's control , or it could be subject to subpoena by the U.S. government .
