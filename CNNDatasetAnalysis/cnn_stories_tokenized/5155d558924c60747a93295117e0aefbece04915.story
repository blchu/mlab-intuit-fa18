-LRB- Mashable -RRB- -- As with any high-profile product release , Apple 's new iPad device has been peppered with complaints since reaching consumers ' hands on March 16 . Among them : that magazines look terrible on the iPad 3 ′ s high-resolution display .

The complaints were first brought to light by Tumblr blogger Jamie Billett . He pointed out that in the New Yorker 's iPad app , the text on some pages is rendered as HTML , and the text on other pages is rendered as an image -LRB- . png -RRB- file .

The latter pages now appear `` badly aliased '' -- i.e. conspicuously pixelated -- throughout the app because the images have n't been formatted to accommodate the iPad 3 ′ s 2048 x 1536-pixel resolution , he complains . -LRB- The iPad 2 , by comparison , has a resolution of 1024 x 768 pixels . -RRB-
...
But what will the ` optimization ' process entail ? How much will it increase file sizes ? -LRB- We noticed , for instance , that Vogue 's premiere issue was a full 408 megabytes on the iPad 3 , and less than 300 on the iPad 2 . -RRB-
...
Magazine publishers who use Adobe 's software all begin with InDesign to develop layouts , Koch explained . Those layouts can then be exported in three different kinds of formats : as images -LRB- . png or . jpg -RRB- , PDF or HTML .

Different kinds of files -- images , for instance , or video and audio files -- are embedded within those larger file types .

Since magazines began publishing on tablets , `` virtually all '' publishers have chosen to export their digital editions as PNG -LRB- . png -RRB- files , Koch said . `` The primary reason they did that is because the fidelity is perfect .
...
But why not render in HTML ? I asked Koch . Would n't that make the files smaller , and give readers the added benefit of selectable text ?

Koch claimed that publishing in HTML would n't substantially reduce the file sizes . `` In both cases , you have a bunch of words , and descriptions of where things should be , and multimedia . Those multimedia files are still the same size . ''
