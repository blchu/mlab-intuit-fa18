...
In the Ice Cream Sandwich version of Android , Google has added a `` Recent Apps '' feature that pulls up a listing of most frequently used apps when you click the system bar icon . But in Windows 8 , switching between open apps is much more intuitive and easy : A swipe from the left edge of the device will immediately pull up the last app you used -LRB- assuming it 's still open in a multitasking state -RRB- . It 's a natural gesture , and one you 'll rarely use by accident .

And best of all , it 's fast -- like channel surfing for the tablet era .

And how 's this for clever : If you know you have a large number of apps open , you can simply swipe back and forth on the edge of the screen , and up pops a vertical array of preview windows revealing all your running programs -LRB- see screenshot above -RRB- . From here , you can tap on a preview to jump to a specific app . Again : another solution that 's easy , quick and elegant .
...
The case is similar -LRB- and arguably worse -RRB- in Ice Cream Sandwich . You 've got your three virtual navigation buttons at the bottom of the display that are persistent across the UI . You also often have a bar across the top of the screen -LRB- just like in iOS -RRB- that displays battery status , time , and icons that link to other information .
