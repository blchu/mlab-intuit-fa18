...
`` The described technique can not engage or control the aircraft 's autopilot system using the -LRB- Flight Management System -RRB- or prevent a pilot from overriding the autopilot , '' the FAA said . `` Therefore , a hacker can not obtain ` full control of an aircraft ' as the technology consultant has claimed . ''
