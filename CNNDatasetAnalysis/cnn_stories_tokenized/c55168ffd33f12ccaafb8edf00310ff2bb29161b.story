-LRB- CNN -RRB- -- A test of the United States ' only long-range missile defense system failed Wednesday -- the second failure this year in two tries .

The Pentagon 's Missile Defense Agency said both the intermediate-range ballistic missile target and the long-range interceptor missile launched successfully , radar and sensors worked properly and the `` kill vehicle '' deployed . But the `` kill vehicle '' did n't hit the target .
