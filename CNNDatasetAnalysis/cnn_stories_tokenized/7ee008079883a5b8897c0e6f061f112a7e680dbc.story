...
Many parallels between AirAsia 8501 and Air France 447 in June 2009 are obvious . Both aircraft were lost in thunderstorm areas of the Intertropical Convergence Zone -LRB- ITCZ -RRB- . Both crashed at sea where floating debris drifted for days from the point of contact with the sea before being discovered , and both were sophisticated fly-by-wire Airbus aircraft -LRB- though different models -RRB- .
...
The height of the stratosphere -- which tends to put a cap on the height of thunderstorm growth -- averages about 35,000 feet over the mid latitudes -LRB- such as that of mainland USA -RRB- , but reaches to 50,000 feet or more in the ITCZ , providing for the growth of thunderstorms to great heights and accompanying intensity .
...
There is a recent development however that relates to Airbus A320 series aircraft . A December 10 , 2014 , Airworthiness Directive -LRB- AD 2014-25-51 -RRB- describes how control of the aircraft could be lost in flight as a consequence of icing of the angle-of-attack probes and an interaction with the airplane 's stall protection function .
...
Simply put , depending on the position of the angle-of-attack probes when freezing occurs and the subsequent speed of the aircraft , the system may be fooled into thinking that the aircraft is approaching a stalled condition -- even when it is n't . In response , the airplane 's stall protections pitch the aircraft 's nose down to recover . This erroneous pitch down can not be overridden by the pilots unless an emergency procedure in the Airworthiness Directive is followed . All pilots flying this model airplane should be aware of this .
...
Another obvious question is the apparent lack of transmitted position and altitude data after its last known position in cruise . This data is transmitted throughout the flight by a system known as ADS-B -LRB- Automatic Dependent Surveillance-Broadcast -RRB- . This system transmits the airplane 's position and other basic data to ground stations . Though its position is GPS-satellite derived , it is not transmitted to satellites , only to ground stations -- so the range to the nearest receiving ground station is a factor in the availability of that data .
...
Palmer : Real causes wo n't be known until more of the plane is recovered , analyzed