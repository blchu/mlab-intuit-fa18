...
`` Why are green products often more expensive than ones that do n't say they are green or environmentally friendly ? Is it just because green has become a new form of ` premium brand ' ? Is n't this bad news if we want to make more people environmentally aware when they go shopping ? '' Harriet Gladwell
...
Other greener products might be slightly more expensive initially , but generate substantial savings for the consumer . Energy-efficient compact fluorescent lightbulbs -LRB- CFLs -RRB- , for example , are still four times more expensive than traditional cheap incandescent light bulbs . However , CFLs use 75 percent less electricity and last 10 times longer , so they do n't have to be replaced as frequently . As a result , the typical CFL saves consumers $ 30 over the life of the bulb .
...
-LRB- 1 -RRB- Who created the labeling program ? -- Was it created by a manufacturer or a trade association to promote their own products , or was it created by an independent outside organization in an open , public , transparent process ? Is it backed by a respected European or North American government ?

-LRB- 2 -RRB- Does the label require a product to actually meet a specific standard ? -- Some labels are being awarded based on fees paid to a consultant rather than based on compliance with a published standard . Others are being awarded simply by joining a trade association or paying a membership fee .

-LRB- 3 -RRB- Does the label address multiple environmental issues or does it focus narrowly on just a single issue like energy-efficiency or recycled-content ? -- Review the standard to determine whether it covers multiple environmental issues throughout the entire product life-cycle , which includes the raw materials used to make the product , the manufacturing process , transportation and packaging , and the impacts of using and discarding or recycling the product . Make sure the standard covers the environmental issues you and the environmental community are most concerned about .

-LRB- 4 -RRB- What does a manufacturer have to do to prove a product meets the standard ? -- Some labels permit a manufacturer to determine on its own whether it meets the published standard . Other programs -- including EcoLogo , Green Seal , and the Chlorine Free Products Association -- independently review product test data and visit the manufacturing facilities to ensure compliance with the standard .
