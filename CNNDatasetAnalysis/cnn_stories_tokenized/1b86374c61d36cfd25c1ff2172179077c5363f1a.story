-LRB- CNN -RRB- -- Let 's face it : Most of us do n't e-mail , tweet , text or post anything worthy of clandestine scrutiny .

But having concerns about NSA cybersnooping does n't mean we must surrender all privacy -- what 's left of it -- in our day-to-day online activities .
...
Specifically , encryption has come up a lot in recent days . For one , NSA whistleblower -LRB- some would say `` traitor '' -RRB- Edward Snowden said Monday in an online question-and-answer session that e-mail encryption is an effective way of foiling government surveillance .
...
Encryption is a method of securing your files , including e-mail , by encoding it so that the intended recipient can read it , but anyone who may intercept the message along the way can not .

An encryption tool turns your original message -LRB- called `` plaintext '' -RRB- into a garbled mess -LRB- or `` ciphertext '' -RRB- while it 's flying from Point A to Point B . The system gives the approved recipient a decryption tool which makes the text readable once it arrives at its destination .
...
A `` secure sockets layer '' -LRB- SSL -RRB- provides a layer of security during everything from Web browsing to text messaging . Many major websites offer the option of using a secure connection all the time . Williamson and other security experts suggest doing this when given the option .
...
But for people who are really worried about their e-mails being intercepted -- and that 's always just an unsecured network and an eager hacker away -- Williamson suggests buying encryption software . -LRB- Note : His company focuses on network security and does not sell encryption software to individuals -RRB- .
...
In effect , disk encryption scrambles everything stored to your computer , requiring a password or other approved recovery tool to decode it . So , if your computer falls into the wrong hands , all wo n't be lost .
