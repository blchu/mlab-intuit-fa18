-LRB- CNN -RRB- -- If the pings reported by the Chinese and Australians turn out to be from Malaysia Flight 370 's data recorders , we may be on the road to finding the plane and solving the mystery of its disappearance .
...
Although many countries are adapting an ADS-B system , mandating it all over the globe would be a difficult process . Most airlines have an ACARS system but it would require modifications to re-wire into an emergency -LRB- electrical -RRB- bus . And it would require airlines to subscribe to the higher level of data downloading .
