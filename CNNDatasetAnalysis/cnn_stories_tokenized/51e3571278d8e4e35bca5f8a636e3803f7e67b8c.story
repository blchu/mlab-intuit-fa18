...
In many of the world 's most remote areas , poverty is a more pressing concern than Internet connectivity . People can not afford electricity or clean water , let alone phones . However , humanitarian organizations have been pushing for more access in these remote areas to improve the efficiency of aid work . For example , it would make it easier to set up remote health care stations in situations where the nearest doctors or hospitals are hours or days away .
