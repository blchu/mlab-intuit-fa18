-LRB- CNN -RRB- -- Users spent just 3.3 minutes on Google + in January compared to 7.5 hours for Facebook , according to a new comScore report .
...
Reps from Google could not be reached for comment on the report . In the past , Google has taken issue with third-party reports about Google + , noting that they do n't track users who access the site remotely , among other factors . -LRB- ComScore does n't include mobile users in its data , though it plans to soon . -RRB-
