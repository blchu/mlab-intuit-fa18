-LRB- CNN -RRB- In his CNN opinion piece , `` The Big Dangers of Big Data '' , Konstantin Kakaes of New America raises some interesting points about the ways that designing certain types of Big Data projects could lead to bad societal results .
...
Modern analytics are far different . For example , every year , the Institute for Operations Research and the Management Sciences -LRB- INFORMS -RRB- holds an international analytics conference that includes a competition for best work in analytics , Big Data , and the applied mathematical field of operations research .
...
Yale School of Management Professor Edward H. Kaplan -LRB- and INFORMS president-elect -RRB- explained in a recent blog post on the website of Oxford University Press how to examine data using the same staffing models used for telephone call centers . He then combined this sophisticated math modeling technique of queueing theory with a study he conducted of all jihadi terror plots detected in the United States over a 10-year period , resulting in a determination that an optimal staff level of only 2,080 counterterrorism agents are needed in the United States . -LRB- The last publicly available FBI staffing figure available in 2004 showed that 2,398 agents were dedicated to counterterrorism at that time -RRB- .
