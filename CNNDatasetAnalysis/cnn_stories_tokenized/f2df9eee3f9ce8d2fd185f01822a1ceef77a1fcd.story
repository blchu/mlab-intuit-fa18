Seoul , South Korea -LRB- CNN -RRB- -- As senior U.S. officials sought to figure out how to respond to North Korea 's announcement that it will launch a satellite using ballistic missile technology , a State Department spokeswoman said Friday that an agreement by the United States to deliver food aid to the impoverished country would be put on pause .
