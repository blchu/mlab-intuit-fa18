-LRB- WIRED -RRB- -- LinkedIn announced a new platform Wednesday for its business-focused social networking site -- offering websites and developers easy tools to embed `` recommend '' buttons , company-profile boxes and contact widgets on third-party websites -- as well as a way to log in to other sites using LinkedIn .
...
Though LinkedIn 's new platform does n't mention Facebook by name , the term `` Professional Web '' clearly shows the company trying to position itself as a more mature and respectable alternative to Facebook .

The new tools rely on JavaScript APIs and the OAuth 2.0 system for logins -LRB- the same as used by Yahoo , Google and Twitter , among others -RRB- .
