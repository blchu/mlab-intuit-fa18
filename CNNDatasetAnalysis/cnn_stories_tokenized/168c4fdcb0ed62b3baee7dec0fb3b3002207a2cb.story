-LRB- CNN -RRB- A year later , it still sounds impossible : A sophisticated $ 270 million airliner carrying 239 people disappears , leaving very few clues about where it went .
...
Take GPS for example . Why are n't air traffic controllers using it to constantly track all commercial airliners ?

How about communicating with satellites ? Why do n't all airliners stream their so-called black box data to satellites in real time ?
...
If an aircraft 's transponders are turned off , an aircraft can be seen only through so-called primary radar . In these cases , air traffic controllers see only a blip on radar screens . The blip is n't identified and the plane 's altitude is unknown .
