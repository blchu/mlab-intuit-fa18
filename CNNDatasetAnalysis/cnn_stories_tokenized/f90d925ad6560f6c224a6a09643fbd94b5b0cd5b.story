-LRB- CNN -RRB- -- The rapid evolution of mobile technology has placed quite a burden on our brains .
...
For example , one day we might be able to design apps that allow people to probe their own cognitive abilities -LRB- processing speed , memory , decision-making , etc. -RRB- at any time during the day and track these abilities over the years , transmitting the results from their smartphones to a health care provider if desired . This real-time data will be more powerful than what we currently obtain by using questionnaires and cognitive snapshots during stressful visits to the doctor 's office . Over time , with growing databases across the population , you can compare yourself to any of your cohorts .
