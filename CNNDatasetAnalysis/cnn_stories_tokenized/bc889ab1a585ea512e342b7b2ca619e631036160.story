-LRB- CNN -RRB- -- For a few minutes Thursday evening , Facebook was redirecting users visiting dozens of websites -- including Mashable and CNN -- to cryptic error pages .
...
For example , if you were visiting Mashable and logged into our site using your Facebook account -LRB- and you were also signed into Facebook -RRB- , you were automatically redirected to a Facebook error page .
...
Over the span of just a few years , Facebook logins have become so pervasive that they are nearly second nature . It also shows that if Facebook has an issue , it can affect more than just its site -- it can also impact the hundreds of thousands -LRB- millions ? -RRB- of sites that integrate with Facebook 's APIs .

What 's interesting is that a user did n't even need to be performing the action for the error -- and hijacking -- to occur . Instead , simply being logged into both places -LRB- and having the accounts linked -RRB- was enough to force users off of a third-party website and onto Facebook 's error page .
