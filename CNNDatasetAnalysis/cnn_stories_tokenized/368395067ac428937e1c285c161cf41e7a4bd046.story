-LRB- CNN -RRB- -- Customer support tool Zendesk announced in a blog post Friday that it had been hacked earlier this week . The hack affected users of three services that use Zendesk : Pinterest , Tumblr and Twitter .
...
`` We recently learned that the vendor we use to answer support requests and other emails -LRB- Zendesk -RRB- experienced a security breach , '' said Pinterest in an email . The pinboard-style photosharing social network site said it was only sending the e-mail to people who had used Zendesk and were possibly compromised .
