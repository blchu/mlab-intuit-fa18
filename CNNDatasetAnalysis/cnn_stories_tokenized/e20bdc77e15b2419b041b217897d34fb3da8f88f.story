...
`` They did n't get as much money to use as the decadal survey assumed , '' said Hartmann , an atmospheric science professor at the University of Washington . `` Some things cost more , especially launch vehicles , so the overall cost has gone up . ''

Meanwhile , science budgets for both NASA and NOAA are n't keeping pace with inflation , he said , and NASA has lost two previously planned missions after liftoff .
...
Willis relies on radar imaging from the Jason-2 satellite , which monitors the rise in sea levels scientists say is a sign of a rise in global temperatures . Jason-2 's expected lifetime is up in mid-2013 , but its scheduled replacement , Jason-3 , is n't likely to be launched until late 2014 . If the current satellite goes out before the new one goes up , it would break a string of uninterrupted observations that date back to the early 1990s .
