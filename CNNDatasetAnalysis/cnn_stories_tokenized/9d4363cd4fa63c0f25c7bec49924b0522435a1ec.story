-LRB- CNN -RRB- -- Since the U.S. Copyright Office declared last month that it 's legal to jailbreak your iPhone , lots of iPhone users have been doing just that -- nearly 9 percent of them as of late July .
...
He then directed his victims to PayPal and requested $ 5 -LRB- about $ 10 -RRB- in exchange for instructions to remove his hack .

At least he let his victims know they 'd been hacked . Your iPhone wo n't notify you about that on its own .
...
`` I 've got ta say , this was not a compelling experience . It was complicated as heck to figure out how to jailbreak the phone and then change the default passwords , '' said Taylor , a longtime tech expert .
...
Sitarzewski explained , `` Every Unix system on the planet has a root account , and the default password for that account is the same on every iPhone on the planet -LRB- ` alpine ' -RRB- .

`` When you jailbreak your phone , sometimes one of the requirements for an app is secure shell -LRB- SSH -RRB- . That 's the only way you 're opening yourself up to this particular vulnerability . So you do n't absolutely have to change your root password if you do n't install SSH protocols -- but it 's a good idea anyway . ''

Taylor added : `` Not only is the default root password the same on every iPhone , but the default mobile user account password also is the same on every iPhone -LRB- ` dottie ' -RRB- . So you should change them both . ''
...
They note that as of early August , some jailbroken iPhone users running iOS4 reported problems with the terminal -LRB- a command-line interface that lets you access system-level functions -RRB- , and pointed to a TiPb discussion forum for instructions on fixing that problem .
