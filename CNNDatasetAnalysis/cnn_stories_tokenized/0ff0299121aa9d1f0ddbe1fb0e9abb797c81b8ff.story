-LRB- CNN -RRB- -- How are fads started and spread ? Do certain influential people play a key role , or is it truly random ? How does a trend go from new and exciting to old and passe so quickly ? Does having happy friends have an effect on our own happiness ?
...
Our study is preliminary ; we need more data to do a proper evaluation , and the results are subject to any number of biases -LRB- people using language differently across the United States , and different demographics using Twitter at different times -RRB- . Our approach simply looks , for example , for occurrences of `` happy '' or `` unhappy '' words in tweets . However , because we take words out of context , our approach will not correctly interpret tweets like `` I am not happy '' .
...
This is why researchers owe a debt of gratitude to Twitter for its policy of open access to public tweets -LRB- exemplified by the recent donation of its entire public tweet history to the Library of Congress -RRB- .

Like any scientific tool , the ability to use the data for research is subject to caveats and limitations . Unlike many existing tools , such as surveys and polls , researchers can not ask a question of the Twitter users directly ; instead , researchers must determine whether the question is one that the Twitter data can answer .
