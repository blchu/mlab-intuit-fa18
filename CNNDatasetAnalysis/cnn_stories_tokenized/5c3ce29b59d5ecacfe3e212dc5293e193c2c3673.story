-LRB- CNN -RRB- -- The battle over health care and whether to use the shortcut tactic known as reconciliation to push it through has thrust the Senate parliamentarian into the spotlight .
...
It 's up to the Senate parliamentarian , Alan Frumin , to advise lawmakers on what can and can not be passed via reconciliation , which requires a simple majority of 51 votes instead of 60 to advance legislation in the Senate .
