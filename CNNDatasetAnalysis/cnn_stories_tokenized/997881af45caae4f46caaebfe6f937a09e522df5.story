-LRB- Wired -RRB- -- Android users , take note : Google Keep -- a long-overdue app for creating lists and reminders -- has arrived .
...
If you snap a photo in the app , you can then edit it using all of Android 's built-in camera features -LRB- cropping , color balancing , photo filters and borders -RRB- . Using Android 's sharing features , you share a photo by e-mail , text messaging , Picasa , Google + , Facebook , Twitter , Instagram , Path , Dropbox and even Amazon 's Send to Kindle feature .
...
Keep is only compatible with phones and tablets running Android 4.0 Ice Cream Sandwich or newer , and as of now , there are no Keep apps for iOS , Windows Phone or any other mobile operating systems . If the app takes off -LRB- and it should , because it works well and looks fantastic -RRB- , then we 'd guess that a Keep app on iOS is only a matter of time .
