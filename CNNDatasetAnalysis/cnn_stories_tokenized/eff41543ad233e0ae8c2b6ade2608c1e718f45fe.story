...
`` Most people have just focused on the presence of flu . The very simple thing is you look at Twitter and look at the number of people using the world flu or sick everyday , '' said Dredze . `` The problem with that is if you look a little more closely it does n't really work . ''
...
Tracking influenza and other illnesses based on social media is n't new . In a 2011 paper , researchers reported being able to accurately track disease levels for the swine flu outbreak two years earlier by searching for keywords such as flu , vaccine , illness , Tamiflu and pneumonia .

The University of Rochester has turned research about predicting the spread of diseases with social media into a web application called Germ Tracker . The colorful interactive map pulls up geo-tagged Tweets that contain keywords related to illness . If you find a tweet that 's clearly mislabeled -LRB- like someone bragging that their new car is `` sick '' -RRB- , click a button to let the app know they 're not actually sick . It also allows self reporting with a slider you can set to Awful , Sick , Yuck , Meh or Good and options to share specific symptoms .
