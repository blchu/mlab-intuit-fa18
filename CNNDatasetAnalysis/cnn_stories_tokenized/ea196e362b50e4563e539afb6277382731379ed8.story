...
Statements that the Aircraft Communications Addressing and Reporting System was intentionally disabled , for example , leave out the fact that the ACARS is required to send the satellite contact requests -LRB- so-called `` handshakes '' -RRB- that , according to news reports , were reported to have occurred for hours after the flight 's disappearance .
...
For example , one part of this communications system is used for messages between the airplane and air traffic control -LRB- clearances , position reports , etc -RRB- . Another is used to communicate , essentially with text messages , between the airplane and the airline . Messages can also be sent automatically for maintenance functions such as reporting faults and sending routine engine data . The range of functions that would have been available for someone to disable is not yet clear .
...
This would be true especially if the airplane 's auto-throttles were also for some reason disabled . There have been statements made that such changes could only be made by a skilled aviator , but what `` skilled aviator '' can not hold altitude within 20,000 feet ?

Incapacitation or something else that could prevent the crew from controlling the plane -- fire , collision , explosive depressurization -- could also be indicated , which would n't necessarily mean the cockpit was breached by anyone .

The airplane reportedly made `` suspicious turns . '' However , it is the nature of those turns that will reveal if it was deliberate `` heading '' -LRB- directional -RRB- changes or if nobody was flying the airplane at all . If the autopilot was off and the airplane was essentially flying on its own , I would expect a variety of heading changes . These changes could be initiated by turbulence during flight .
...
If the flight path can be shown to be very straight lines with neat turns followed by another straight line , then I would throw out the `` autopilot-off '' theory , but it seems as though officials ca n't even determine where the plane was heading , much less the nature and cause of some heading changes .
