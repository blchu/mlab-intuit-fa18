-LRB- CNN -RRB- -- Configuring your Facebook settings from a laptop is confusing enough , but try monitoring your Facebook privacy and security setting on a mobile phone . It 's even more of a mess .
...
MobileActive 's mobile Facebook guide is written with activists in mind -LRB- especially in light of the key role that Facebook played in many Arab Spring uprisings -RRB- , but it 's useful for any Facebook user .
...
For instance , many people set their phone to use a Wi-Fi connection whenever possible , in order to curb their data usage , which can get expensive . If you use Wi-Fi on your phone , depending on how your mobile browser or Facebook app handles security , someone might snoop on your login credentials -LRB- `` sidejacking '' -RRB- and use them to impersonate you on Facebook . They could even lock you out of your own account .

Sidejacking is a Wi-Fi-related risk for many online services , not just Facebook . The main way you can protect yourself is to always use a secure connection -LRB- URLs that begin with `` https '' rather than `` http '' -RRB- when logging in to an online account from any device , including your phone .

You can configure your Facebook account to always use `` https . '' However , MobileActive cautions : `` Be aware that this setting is not applied when browsing from a phone ! You may also notice that some applications warn you that you can not access them using HTTPS . If you use such applications , be aware that they may turn the ` always use HTTPS ' setting off -- you will need to go back into your account settings and turn it back on every time . ''
...
It 's a good idea to bookmark the mobile websites for the services you use -- the URL versions that start with `` https , '' of course -- on your phone 's browser . Then use those sites -LRB- rather than service-specific apps -RRB- when accessing them over an open or shared Wi-Fi network .

Also , check that your mobile browser really can make a secure Web connection . MobileActive notes that some older or more primitive browsers -LRB- probably including many browsers that come pre-installed on feature phones -RRB- may revert the connection to `` http , '' which is not secure . So once you 've tried to access a site using `` https , '' after the page loads , double-check the location bar in your browser to make sure it still says `` https . ''
