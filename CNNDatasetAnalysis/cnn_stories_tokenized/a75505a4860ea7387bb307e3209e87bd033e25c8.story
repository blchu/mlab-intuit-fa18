...
You do n't need to know code to build a website . Macaw is a visual web design tool that lets you code without actually typing out code . The app has an image editor and a design-to-code engine so that you can `` draw '' out your site layout and the app will do the coding for you .
