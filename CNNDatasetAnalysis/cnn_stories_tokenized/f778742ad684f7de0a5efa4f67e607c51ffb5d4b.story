-LRB- CNN -RRB- -- In a big swerve in policy , Google has decided to allow people to sign up using nicknames or other pseudonyms on its growing social network , Google + .
...
They will also be able to change their actual name to an assumed one . -LRB- One amusing example ? Madonna -RRB- .
...
-LRB- Gmail does have a `` send mail as '' field in its settings that lets users change how their name appears each time they send a message -RRB- .

`` We are many things to many people , and that 's what most nicknames are about ; we would n't necessarily want our parents to know how our friends call us , and vice-versa ... . , '' Helm wrote .

`` One thing is for sure , this is a huge missed opportunity -- after all , did n't Google + acknowledge early on that our social life revolves around different Circles ?

She clarified , however , that complaints do n't negate high hopes for the site .
...
In his post , Horowitz said that only a tiny percentage of Google + users have issues with the names they submit . Only about 0.1 percent -LRB- one/tenth of one percent -RRB- submit name appeals , he said . Of those , about 60 percent simply want to add a nickname and 20 percent are businesses who accidentally tried to set up an account as an individual .

The struggle is n't unique to Google , which last week announced that the site now has more than 90 million users .

Facebook policy also requires users to register for the site with their real names . That site 's terms and conditions state : `` We reserve the right to remove or reclaim -LSB- a user 's name -RSB- if we believe appropriate -LRB- such as when a trademark owner complains about a username that does not closely relate to a user 's actual name -RRB- . ''

The sheer size of Facebook -LRB- the site claims more than 800 million accounts -RRB- means it may take longer for fake accounts to be found , though .
