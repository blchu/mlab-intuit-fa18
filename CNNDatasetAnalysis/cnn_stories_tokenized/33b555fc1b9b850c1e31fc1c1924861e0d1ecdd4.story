-LRB- CNN -RRB- -- A month ago , Google 's three-year effort to push its Web browser , Chrome , took a major step when analysts said it had passed Mozilla 's Firefox to become the second-most popular tool of its kind on the Internet .
...
Microsoft , putting a positive spin on the numbers , emphasized that Explorer 's latest -LRB- and generally well-received -RRB- version , IE9 , is rapidly gaining ground as use of IE8 drops . IE9 was released in March .

-LRB- To its credit , Microsoft is also celebrating the demise of Internet Explorer 6 . Widely reviled by Web developers and many users from the start , use of that version dropped below 1 % in the United States last month , with Microsoft spokesman Roger Capriotti writing on the Windows blog that the company is breaking out the champagne and `` as eager as anyone to see it go away . '' -RRB-
...
The rise of Chrome comes as Google has expanded beyond its core product -- its search engine -- into such areas as mobile operating systems -LRB- Android -RRB- and social networking -LRB- Google Plus -RRB- . Chrome has been a high point for Google in what has developed into a two-front clash of tech titans with Microsoft .
...
One victim of Google 's success -LRB- not to mention deep pockets -RRB- has been Firefox , long a favored browser among tech-savvy types .

`` They -LRB- Mozilla -RRB- were not coming out with a lot of releases and new features for some time , '' Smith said . `` They 've really tried to change that in the last year , but perceptions got made during that time frame .
