-LRB- CNN -RRB- -- Tokyo faces the possibility of being hit by a massive earthquake within the next four years , according to Japanese researchers .
...
`` Seismologists can not predict with certainty when , where and how large the next big earthquake will be , '' he wrote in an e-mail to CNN . `` However , it is possible to forecast the probability of an earthquake in a particular time range -LRB- e.g. the next four years -RRB- , location area -LRB- e.g. the Tokyo region -RRB- , and magnitude range -LRB- e.g. greater than magnitude 7.0 -RRB- .
