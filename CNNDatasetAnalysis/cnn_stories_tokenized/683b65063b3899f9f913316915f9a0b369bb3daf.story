-LRB- CNN -RRB- -- Social-networking giant Facebook has entered the check-in world .
...
`` After checking in , your check-in will create a story in your friends ' News Feeds -LSB- on Facebook -RSB- and show up in the Recent Activity section on the page for that place , '' Places product manager Michael Sharon wrote on Facebook 's blog .
