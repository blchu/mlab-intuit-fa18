-LRB- CNN -RRB- There are many reasons why the Internal Revenue Service is perhaps the least-loved agency in America -- a tax code so complex that it seems like you need an advanced degree to understand it , the dreaded audit process and revelations that certain groups have been targeted based on their political beliefs .
