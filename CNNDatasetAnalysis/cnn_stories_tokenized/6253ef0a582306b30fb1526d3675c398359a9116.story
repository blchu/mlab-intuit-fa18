...
`` The provision is thus unconstitutional root and branch and can not be saved , as the majority suggests , by limiting its application to the single facility that has experienced the safety and access problems to which it is quite obviously not addressed . ''
