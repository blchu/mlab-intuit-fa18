Washington -LRB- CNN -RRB- -- A federal watchdog took a bite out of military hospitals this month , warning it is impossible to tell if some doctors are licensed , properly trained and evaluated in their specialties .

`` Army oversight and physician credentialing and privileging requirements were not sufficient to assure that MTFs -LRB- Medical Treatment Facilities -RRB- fully complied with existing requirements or completely documented information needed to support credentialing and privileging decisions , '' said the new General Accountability Office report .
