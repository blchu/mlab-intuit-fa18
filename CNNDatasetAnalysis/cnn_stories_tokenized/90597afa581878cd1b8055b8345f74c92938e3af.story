...
`` We are working with Pakistan 's civilian authorities to investigate further into this organization , but definitely -LSB- Lashkar-e-Tayyiba -RSB- maintains some level of connections with al Qaeda , '' Benjamin said at the briefing -LSB- WHEN added above -RSB- .

Earlier this year , Benjamin said of the Mumbai attacks : `` The target was set directly out of -LSB- Osama -RSB- bin Laden 's book , filling the gap created by a diminished al Qaeda . ''
