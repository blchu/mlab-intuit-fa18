-LRB- Mashable -RRB- -- Facebook accidentally went live with a handful of prototype features earlier today , including a site-wide yet short-lived overhaul of Pages .
...
So what were those prototypes exactly ? Screenshots shared with us and surfaced through other media outlets suggest all of the following : new Facebook Pages -LRB- with Questions integration -RRB- , a `` Switch Accounts '' feature for Page Admins , a new Memories feature that chronicles photos and status updates from years past and an `` Outside World '' filter for the News Feed .
...
Memories would make for a pleasant -LRB- hopefully -RRB- walk down memory lane , so we hope this features finds its way back to Profile Pages in the near future .
