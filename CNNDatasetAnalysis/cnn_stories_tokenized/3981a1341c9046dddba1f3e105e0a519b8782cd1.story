-LRB- CNN -RRB- -- Say it with us : Kids today have it sooooo easy .
...
The app can do arithmetic : addition , subtraction , division and multiplication . It can handle fractions . It knows what 23 is and can calculate the root of 246 . It can even do simple linear equations , provided the x you 're solving for is italicized so the app does n't confuse it with the x multiplication symbol .

The only catch is that the equation you 're trying to solve must be printed text , rather than handwritten . So forget trying to calculate that tip by scribbling it on a restaurant napkin . -LRB- Do n't worry , there 's already a million apps for that . -RRB-
