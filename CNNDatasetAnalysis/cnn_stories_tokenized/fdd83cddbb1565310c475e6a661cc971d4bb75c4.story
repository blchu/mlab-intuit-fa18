-LRB- CNN -RRB- -- Facebook announced an update to Graph Search on Monday that will enable users to search for conversation topics within status updates , comments and posts . Some users with Graph Search can now browse Facebook for topics of interest â $ '' for example , `` posts about Breaking Bad '' or simply `` Breaking Bad . ''

The update also allows users to search for posts or comments from a certain time period or location -LRB- for example , `` posts by my friends from last month '' -RRB- or posts that they already composed or commented on .
...
When users ' eyes are n't glued to the TV screen , Facebook and Twitter want them to be having conversations or voicing their opinions on their respective networks .

Opening up Graph Search to enable post and comment searches will help Facebook to do so . When a user logs into his profile during a primetime event , he can quickly scan all conversations about the game or his favorite show â $ '' even if he is n't near the top of the News Feed . If a user want to talk about an event hours -LRB- or even days -RRB- later , he can search for all relevant conversations on Facebook , something users ca n't easily do using Twitter .
