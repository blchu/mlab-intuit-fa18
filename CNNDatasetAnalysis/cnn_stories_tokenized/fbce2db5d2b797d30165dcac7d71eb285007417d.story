-LRB- CNN -RRB- -- I 've just returned from a visit to Tanzania with the global health and development organization Population Services International to better understand the challenges facing health workers in the developing world . The outbreak of Ebola only underscores the dire need for trained health workers -- a global shortage of nearly 7.2 million health workers , according to the World Health Organization .
