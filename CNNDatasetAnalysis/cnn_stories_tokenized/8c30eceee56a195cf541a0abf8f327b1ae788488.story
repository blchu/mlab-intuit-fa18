...
The camera is one of the iPhone and iPod touch 's killer features -LRB- less so on the iPad , if only because holding up a giant rectangle to take a snapshot is cumbersome -RRB- . New camera features are always one of the more fun updates , and this round has two notable new tools . -LRB- Last iOS update we gained the ability to edit photos directly in the Camera Roll and an overlay grid . -RRB-
...
There is a new VIP option for those important emails you ca n't dare miss . Click on any sender 's name and select Add To VIP , and in the future all emails from that address will appear in the special VIP folder . The VIP folder will show up in the Mail app no matter what , even if you do n't plan on using it . It 's also possible to flag important email .
