-LRB- CNN -RRB- -- Twitter users are rightly aghast that the company on Sunday banned a user for openly criticizing NBC 's coverage of the Olympics . After Guy Adams , a British newspaper reporter for The Independent , posted negative comments about NBC 's tape-delayed Olympics coverage -LRB- including one executive 's work e-mail for viewers to make complaints -RRB- , Twitter alerted its business partner -- NBC -- and showed the network how to file a complaint capable of shutting down the offending user .
...
Last month , in an effort to raise advertising revenue , the company announced it was closing its API -LRB- application program interface -RRB- to third-party apps -- meaning people and companies can no longer make applications that stream Twitter data . This makes it harder to see Tweets from places other than Twitter 's own website . It 's an entirely less open service this way , but it also gives Twitter exclusive control over how and where people access its content -- and advertisements .
...
Rushkoff : Users who do n't want to depend on Twitter should explore and/or build alternatives