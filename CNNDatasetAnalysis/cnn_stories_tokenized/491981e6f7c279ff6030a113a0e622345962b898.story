-LRB- CNN -RRB- -- Google unveiled a groundbreaking new Chromebook laptop Thursday -- one with touchscreen capability , powerful chipset and an extremely high-resolution display .

The Chromebook Pixel , available for order on the Google Play store and shipping in April , features a 12.85-inch touch-sensitive Gorilla Glass screen . The resolution is 4.3 million pixels , which works out to 239 pixels per inch . -LRB- The average Windows laptop has about half that ; technically , it also beats the Macbook Retina . -RRB-

The Pixel will come in two versions , both boasting an Intel Core i5 processor . The basic model is Wi-Fi only ; a more expensive model has the ability to connect to Verizon 's superfast LTE network . Google claims a battery life of five hours on the device , which has QuickOffice built into the browser and an SD card slot for automatic photo uploads to Google + . Those features can also be used offline -LRB- uploads queued for later , of course -RRB- .

The price , however , is relatively steep : $ 1,299 for the Wi-Fi only version , $ 1,449 for the LTE model .

Google was careful to emphasize that the Pixel is n't for everyone . `` This is for power users who live in the cloud , '' Senior Vice President of Chrome Sundar Pichai repeatedly told a select group of journalists at a low-key launch event in San Francisco .

Having a touchscreen does n't mean that Google plans to integrate its mobile OS , Android , into the device . But Pichai hoped web developers would start making their interfaces touch-sensitive -- so that content on the device would be indistinguishable from Android .
