...
Haas and his team at the UK 's University of Edinburgh , are the brains behind a new patented technology that uses beams of flickering light to transmit digital information wirelessly , a process known as Visible Light Communication -LRB- VLC -RRB- .
...
`` Of course one problem is that light ca n't pass through objects , so if the receiver is inadvertently blocked in any way , then the signal will immediately cut out , '' Kamalakis says .
...
`` We still need Wi-Fi , we still need radio frequency cellular systems . You ca n't have a light bulb that provides data to a high-speed moving object or to provide data in a remote area where there are trees and walls and obstacles behind , '' he says .
...
`` It 's a very simple electromagnetic spectrum we can see , and if that is an engine that also provides some of the fundamental needs of modern societies -LSB- like -RSB- high-speed data communication , would n't that be brilliant ? ''
