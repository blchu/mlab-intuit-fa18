...
The EIDM tool designed by another contractor , which Campbell 's advance testimony does n't name , `` created a bottleneck that prevented the vast majority of users from accessing '' Healthcare.gov when it opened , according to Campbell .
...
`` This may have driven higher simultaneous usage of the registration system that would n't have occurred if consumers could ` window shop ' anonymously , '' Slavitt 's testimony says , adding that the EIDM tool was able to process the high volumes with low to zero error rates by October 8 .
...
`` More individuals have enrolled in qualified insurance plans ; however , the increased number of transactions ... have caused system performance issues -LRB- such as slow response times or data assurance issues -RRB- that now need to be addressed through tuning , optimization and application improvements , '' her testimony says .
...
The White House has been pushing back against not just Republicans , but some Democrats who have urged an extension of the open enrollment period beyond March 31 and/or a delay in penalties for those who do n't sign up for insurance on time because of the website issues .
