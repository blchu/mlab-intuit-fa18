...
The Court of Claims -LRB- affirmed by the Court of Appeals -RRB- rejected Marriott 's technical analysis , finding no reliable argument or authority to support it . The court therefore did not need to reach the issue of business purpose and economic substance . In subsequent decisions , involving similar transactions but other parties , the courts have sustained the second line of attack as well , finding the claimed losses to be fictitious .
