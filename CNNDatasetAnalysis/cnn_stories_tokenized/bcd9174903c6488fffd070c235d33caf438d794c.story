-LRB- CNN -RRB- -- There are no pure `` winner-take-all '' contests on Super Tuesday , but almost all of the 10 states holding contests on the biggest day of the primary season offer candidates some chance of shutting out their opponents in the all-important race to amass delegates .
...
Delegate allocation rule : Proportional . 34 statewide delegates allocated in proportion to statewide vote , with a 20 % threshold ; 42 district delegates -LRB- 14 districts with 3 delegates each -RRB- winner-take-all by district if winner gets more than 50 % , otherwise modified proportional .
...
Delegate allocation rule : Proportional . 15 statewide delegates winner-take-all if a candidate receives more than 50 % of statewide vote , otherwise proportional with 20 % threshold ; 48 district delegates -LRB- 16 districts with 3 delegates each -RRB- winner-take-all by district vote .

Santorum did not submit any delegate slates in three districts -LRB- congressional districts 6 , 9 , and 13 -RRB- , which means he can not win any delegates from these districts . In six additional districts -LRB- CDs 3 , 4 , 8 , 10 , 12 , and 16 -RRB- , he submitted only partial delegate slates , which means that if Santorum wins any of these districts , he will only receive one or two out of the three possible delegates in that district .
...
Likelihood : Unlikely . If Santorum wins statewide , he can not win every CD because he has n't fielded full delegate slates . If Romney wins , it 's unlikely he 'll win more than 50 % statewide and also unlikely that he would carry every CD .

OKLAHOMA

Delegate allocation rule : Proportional . 25 statewide delegates winner-take-all if candidate receives more than 50 % of statewide vote , otherwise proportional with 15 % threshold ; 15 district delegates -LRB- five districts with three delegates each -RRB- winner-take-all by district vote if winner gets more than 50 % of district vote , otherwise proportional by CD vote with modified 15 % threshold
...
Delegate allocation rule : Proportional . 28 statewide delegates winner-take-all if winner receives more than 66 % of statewide vote , otherwise proportional with 20 % threshold ; 27 district delegates -LRB- nine districts with three delegates each -RRB- winner-take-all by district vote if winners receives more than 66 % of district vote , otherwise proportional with 20 % threshold .
...
Delegate allocation rule : Proportional . 13 statewide delegates winner-take-all if winner receives more than 50 % of statewide vote , otherwise proportional with 15 % threshold ; 33 district delegates -LRB- 11 districts with three delegates each -RRB- winner-take-all by district vote .
