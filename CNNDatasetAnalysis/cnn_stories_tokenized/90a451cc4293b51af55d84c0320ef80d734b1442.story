-LRB- CNN -RRB- -- The residents of Colorado and Washington state have voted to legalize the recreational use of marijuana , and all hell is about to break loose -- at least ideologically . The problem is that pot is still very much illegal under federal law , and the Obama administration must decide whether to enforce federal law in a state that has rejected the substance of that law .
