-LRB- CNN -RRB- -- Facebook unveiled changes to its terms-of-use document on Friday , tweaking earlier drafts in an apparent effort to ease users ' concerns about privacy and how their information is used .
...
`` Some of our users and a number of journalists mistook the proposed update to our SRR for changes to the way we collect or use data , '' Facebook said in a post on the site . `` Our Data Use Policy -LRB- which used to be called our privacy policy -RRB- governs how we collect and use data . We are not proposing any updates to that document at this time . ''
...
-- Facebook also clarified language saying that people should not `` tag users if you know they do not wish to be tagged '' in photos . That passage does n't change how tagging works , but is merely meant to be a guideline , the company said .
