-LRB- CNN -RRB- -- If you access Facebook via the Web browser on a `` feature phone '' -- a simpler , less powerful cousin to the smartphone -- your experience might improve significantly over the next few weeks .
...
The move to upgrade and unify Facebook 's mobile Web experience also will streamline Web development for Facebook . As if it is n't complicated enough to maintain native apps for each major smartphone operating system -LRB- iOS , Android , BlackBerry , etc. -RRB- , maintaining multiple mobile website versions consumes considerable time and resources .

`` Every time we launched a new feature , we had to build it multiple times across different code bases , '' wrote Byron . `` Once for facebook.com , then again for m.facebook.com , touch.facebook.com , and in native applications as well . Honestly , we were n't very good at doing this , so certain features were missing on different devices . ''
