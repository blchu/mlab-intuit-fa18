-LRB- Mashable.com -RRB- -- At WWDC 2012 , Apple unveiled the next generation of iOS , its mobile operating system . iOS 6 sports more than 200 new features and upgrades -- including the new Apple Maps , deep Facebook integration and improvements to Siri .

Although iOS 6 wo n't be available on compatible devices until sometime this fall , the first beta build is currently available to developers . We 've installed iOS 6 on our new iPad -LRB- 64GB Verizon LTE model -RRB- and poked around with the new features .

While it is clear that this is a beta -- certain features are n't fully baked , and there is some crashing and inconsistency with a few existing apps -- it 's equally clear that this is a solid OS update .

Mashable.com : iOS 6 : Everything You Need to Know

Because we 've tested iOS 6 on an iPad and not an iPhone , we ca n't explore all of the new iOS 6 features . But this release , more than any other , is intended to unify iOS across platforms .
...
While we have n't had a chance to go hands-on in a car with Turn-By-Turn , in our walking tests , it worked as you would expect .

What did n't work as we expected was transit directions , and this could be a real wrinkle for Apple . In Monday 's WWDC Keynote , Apple 's Scott Forstall said that the company would highlight transit apps from the App Store in its mapping product .

At the time , I took this to mean that it would highlight other location apps . What I did n't realize is that Apple is actually going to rely on these apps to power the transit directions within iOS .
...
I like third-party transit apps as much as the next person . But I also really , really like having a schedule built into my main mapping client , so I can quickly get directions in an area where I do n't know the bus or train route layout .

That quibble aside , our first experience with Apple 's new Maps app is positive . In fact , with the exception of Turn-By-Turn nav , it does n't feel that much different than the Google Maps app . That 's a good thing .
...
For now , videos can not be shared directly to Facebook -- only YouTube . But we expect that to change in the future .
...
Apps that hook into the Facebook login in iOS 6 need only request permission to do so once . Actions still need to be explicitly performed ; users just do n't have to initiate a login each and every time .
...
Safari for iOS 6 has a redesigned sharing menu -- icon-based this time -- and the ability to sync with tabs across other iCloud devices . You can also now read items from Reading Lists offline -- which can act as a low-level replacement for Instapaper , Pocket or Readability . In my experience , heavy users of those services -LRB- including myself -RRB- are unlikely to give them up for the built-in options , but it 's a great way to introduce the concept of reading later to more people .
...
Some of the early criticism of iOS 6 is that it is n't enough to compete with Android or Windows Phone . I do n't think this is true at all . Third party apps are what define modern smartphones and tablets and in that respect , Apple remains the platform of choice for developers .
...
While certain features are n't fully baked yet , it 's clear that this is a solid OS update
...
We tested iOS 6 on an iPad and not an iPhone , so we ca n't explore all its new features