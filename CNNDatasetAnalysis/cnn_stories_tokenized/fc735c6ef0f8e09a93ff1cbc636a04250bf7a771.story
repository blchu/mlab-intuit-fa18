-LRB- CNN -RRB- -- Recently , Google announced that the Android version of its Google Maps app now automatically routes users around traffic when providing directions .
...
'' -LSB- Now -RSB- , our routing algorithms will also apply our knowledge of current and historical traffic to select the fastest route from those alternates . That means that navigation will automatically guide you along the best route given the current traffic conditions . ''
