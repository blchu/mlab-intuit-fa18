-LRB- CNN -RRB- -- Apple prides itself on being green .
...
The first bit damaging of news was about Apple 's decision to dump an international green certification system that is used by the U.S. government to determine whether its agencies can or can not purchase a product .

Apple would not comment on exactly why it abandoned the EPEAT environmental standard , which measures a product 's recyclability and energy efficiency . The Internet , however , speculated widely that the company 's new MacBook Pro line is n't easily recycled since the laptops ' batteries are glued to their aluminum cases . And perhaps that was the reason Apple decided to pull out now , before those laptops were reviewed by EPEAT .
