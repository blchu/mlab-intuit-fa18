-LRB- CNN -RRB- -- Google has used its wealth of data to compile an interactive crisis map for massive storm Sandy , giving users up-to-date information about storm surges , power outages , shelters and evacuation routes .
