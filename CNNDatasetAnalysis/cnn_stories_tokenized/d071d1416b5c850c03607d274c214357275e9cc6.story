-LRB- Wired.com -RRB- -- Photographers have their own version of sleight of hand . They can manipulate people , objects , landscapes and light in images , fooling lesser humans into believing the final product is a representation of reality , rather than something created by hand .
...
Photoshop CS5 will arrive as part of Adobe Creative Suite 5 , the company 's package of 14 productivity apps for visual designers , photographers and publishers . Creative Suite 5 will ship later this month -LRB- or possibly early May -RRB- according to Adobe .
...
This year marks the 20th anniversary of Photoshop 's arrival , and there are certainly several `` wow '' features in Photoshop CS5 which achieve a level of technological advancement most of us could n't have even dreamed of twenty years ago .
...
This video shows it most plainly . Fast forward to about the halfway point if you want to see the really crazy stuff . -LRB- When this video first started making the rounds in March , some thought it was a hoax . It 's not -- this is a real feature of Photoshop CS5 . -RRB-
...
Also incredibly helpful for HDR fans is the new `` remove ghosts '' tool in the HDR dialog , which makes it simple to eliminate ghosting and artifacts caused by differences between your layered HDR images . With Photoshop CS5 , you can simply outline a ghosted area -LRB- say , for example , a flower that moved in the breeze between shots -RRB- and select a single layer for the portion of the image .

Photoshop CS5 is n't just new brushes . There 's been plenty of attention to performance -- the Mac OS X version is now fully 64-bit native , the same enhancement the Windows version got in in CS4 . That means that you could , in theory , throw as much as 128 GB RAM at Photoshop .
...
We were also impressed with the new Lens Correction tool , which fixes distortion and other lens artifacts using profiles tailored to correct specific camera lenses -LRB- the lens type is determined by embedded EXIF data , so Photoshop can determine that automatically -RRB- .
...
Among our favorites workflow improvements : You can now adjust the opacity and fill percentages on multiple layers simultaneously ; the Save for Web dialog is available in 16-bit mode -LRB- and handles downsizing to 8-bit automatically -RRB- ; and Photoshop has the ability to save layer styles as a default behavior that even persists across sessions .
