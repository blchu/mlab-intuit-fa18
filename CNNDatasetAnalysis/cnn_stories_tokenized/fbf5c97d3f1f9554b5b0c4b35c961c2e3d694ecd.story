-LRB- Mashable -RRB- -- Some folks at the Hacker publication 2600 decided to compile a list of words that are restricted by Google Instant .

Except in extreme and special cases , Google is known for anything but censorship , but as we 've said before , there are some terms the web giant 's new instant search feature wo n't work with .
...
But Google has opened itself up to a potential PR problem , because some of these omissions will be at best bewildering and at worst offensive to particularly sensitive -LRB- or progressive -RRB- users who do n't understand how Google Instant actually works .
...
That happens because Google Instant does n't just use what you 've typed to display results . It reads data collected over the years about previous users ' searches to predict what you 're going to type .
...
When results fail to appear after you 've typed `` lesbian '' or `` butt , '' it 's not because the results are being censored . Google is struggling to prevent the text of offensive searches users have made in the past -LRB- there have been other controversies on this subject before -RRB- from jumping up in front of you when you 're looking for something innocuous .
...
So , for example , if the results for a particular query seem pornographic , our algorithms may remove that query from Autocomplete , even if the query itself would n't otherwise violate our policies .
...
The rep told us that Google is working on improving the system , but would n't give us any specifics about future changes . In the meantime , check out the complete list at 2600 if you 're curious .
