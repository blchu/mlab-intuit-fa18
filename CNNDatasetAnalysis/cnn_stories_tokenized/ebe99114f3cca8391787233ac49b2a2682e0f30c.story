-LRB- CNET -RRB- -- In an attempt to move beyond drab typography on the Web , Google on Wednesday released 18 freely usable fonts and an open-source tool designed to smooth over browser issues in displaying downloaded fonts .
...
But font licensing rules mean a Web designer ca n't necessarily upload any old font for a site . This is where Google 's move , announced at its Google I/O conference , comes in . The company released 18 fonts and also announced an interface that lets Web sites use them .
...
The way to Web fonts was paved with the Cascading Style Sheets -LRB- CSS -RRB- formatting standard and more recently the Web Open Font Format technology that helped encourage Web typography support from traditional font licensing companies .
