Here 's a thought that might make even the most conscientious e-mail user nervous : `` When the CIA director can not hide his activities online , what hope is there for the rest of us ? ''
...
`` In the case of Yahoo Mail and Outlook that includes the IP address of the connection used to send an email , so investigators do n't need to subpoena a mail provider to trace its origin , '' Tom Simonite writes for the MIT Technology Review .
...
Communicating by saving e-mail drafts on a joint account is old hat : Some reports indicate Petraeus tried to communicate with his mistress by setting up a joint e-mail account with her and then saving messages in the account 's draft folder . So , essentially , they may have been e-mailing each other without actually sending an e-mail . That sounds smart , right ? Very James Bond . -LRB- Or very al Qaeda . -RRB-
...
So maybe all online communications -- every last Internet-connected keystroke -- should be thought of as public , until proven otherwise ? Let us know what you think in the -LRB- newly improved -RRB- comments section below .
