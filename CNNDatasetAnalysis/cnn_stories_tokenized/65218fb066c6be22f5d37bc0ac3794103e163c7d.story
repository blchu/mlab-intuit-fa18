-LRB- Mashable -RRB- -- Call it Cloudgate , Cloudpocalyse or whatever you 'd like , but the extended collapse of Amazon Elastic Cloud Compute -LRB- EC2 -RRB- is both a setback for cloud computing and an opportunity for us to figure out how to stop it from happening again .
...
The trouble was apparently due to excessive re-mirroring of its Elastic Block Storage -LRB- EBS -RRB- volumes -- this essentially created countless new backups of the EBS volumes that took up Amazon 's storage capacity and triggered a cascading effect that caused downtime on hundreds -LRB- or more likely thousands -RRB- of websites for almost 24 hours .
...
Luckily , one of Amazon 's most prominent customers , Netflix , did n't experience problems because it 's built for the loss of an entire data center , while companies relying on Amazon 's four other global data centers did n't experience too many issues .
...
Its Availability Zones are supposed to be able to fail independently without bringing the whole system down . Instead , there was a single point of failure that should n't have been there .

This week 's disaster in the cloud is a reminder to startups to build redundancy into their applications and their own systems , but as Santa Barbara points out , most startups do n't have the time or resources to engineer for multiple cloud systems -LRB- each Amazon global region/data center has its own rules and features , making a simple `` switch '' to another center difficult -RRB- .
...
This incident is no reason for us to shun cloud computing , though . Its benefits -LRB- scalability , cost reduction , device independence , performance and more -RRB- far outweigh its cons .
...
Cloud computing is still in its infancy , and today 's events make it clear that we still have a lot of work to do . It could be a whole lot worse next time if we are n't prepared .
