...
Employees can sign up for Active Hours on their own , providing their bank account number . They use the app to upload a photo of their electronic time sheets -LRB- paper time sheets are n't allowed -RRB- . ActiveHours knows which systems are used by most employers , so it uses a photo of the system to verify the timesheet is real and checks the hours logged against past deposits made into the user 's bank account .
