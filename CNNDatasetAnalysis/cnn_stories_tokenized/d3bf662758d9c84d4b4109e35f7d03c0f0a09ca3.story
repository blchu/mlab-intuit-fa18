-LRB- Wired -RRB- -- Google Voice opened to the public Tuesday .
...
New users get a free new number , hopefully somewhere near their local area , and in anticipation of a rush , Voice has bought a bunch of numbers spread across the country -LRB- though Hawaii and Alaska remain `` challenges '' -RRB- .

`` We are pretty optimistic there will be a high demand , '' Walker said .

Voice also has native apps for Android and Blackberry phones , while Palm Pre and iPhone users can use the HTML5 app -LRB- including to make outbound calls -RRB- . Google made a full-featured app for the iPhone , which Apple controversially rejected on the grounds it would confuse users .

The real cost of iPhone 4 vs. Android rivals

Those who commit to giving out a Google Voice number as their central point of contact are n't locked into Google and can port their number out to a phone company or to competing services such as Toktumi .

Users ca n't yet port their existing numbers into Google Voice , which would eliminate the need to have to `` commit '' to your Voice number by giving it out to friends and contacts , and getting new business cards made .
...
Google is currently integrating this into Google Voice , though there is reportedly some internal friction over whether to scrap the downloadable software in favor of an HTML5 web app , even though the latter would n't have as good voice quality .
