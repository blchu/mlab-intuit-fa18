-LRB- CNN -RRB- -- First it was instant messaging during office hours that gave us the thrill of passing notes in class . Then it was ogling ourselves on Web cams , ranting our minds on blogs , uploading our baby photos on Flickr and poking each other on Facebook . These days , as corporate records show , we choose to spend our lunch breaks watching YouTube , if not chatting over Skype .
...
Over the past two years , well over a dozen startups have sprung into action , bringing everything from IM to VoIP -LRB- Voice over Internet Protocol -RRB- to our mobile phones , in a quest to conquer the cellular fourth screen .
...
The softwares are fully functional on both 3G and any smart -LRB- Internet-enabled -RRB- 2.5 G phones running such platforms as Java , Symbian , Windows Mobile , Blackberry , S60 and the iPhone OS .
...
Playfully packaged , internationally-based Fring works with WiFi providers in Europe and Australia as well as SIP -LRB- Session Initiation Protocol -RRB- providers based in both North and South America , Western and Eastern Europe , South Africa and China , also consolidating all chat buddies into a single mobile contact list .
...
MyHappyPlanet , a free online language-exchange network that allows members to create profiles and chat with language partners in real time -LRB- text , voice , video -RRB- , will go mobile in the near future .
...
From the carrier 's point of view , people 's choice of mobile communication is a question of coverage and user-friendliness -- of `` price , packaging , usability , '' according to CSL 's -LRB- `` Create a Simple Life '' -RRB- chief marketing officer Christina Teo .

`` We try to ` replicate ' any desktop experience to the mobile phone . You can call it replicating , extending , adding value , '' continues Teo . `` And with every new partnership , we need to make sure that the application works on each new handset we launch ... With mobile phones -LSB- as opposed to desktop computers -RSB- there is still some concern , stigma , so we need to educate people to get over that hurdle . It 's the faster we can get it at the click of a button . ''
