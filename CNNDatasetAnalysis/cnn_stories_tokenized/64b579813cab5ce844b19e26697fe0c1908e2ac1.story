...
`` Charging for the various bundles may be by bundle and by duration . For example , the office bundle may be $ 1.00 -LSB- 68 pence -RSB- per hour , the gaming bundle may be $ 1.25 per hour and the browsing bundle may be $ 0.80 per hour . The usage charges may be abstracted to ` units/hour ' to make currency conversions simpler . Alternatively , a bundle may incur a one-time charge that is operable until changed or for a fixed-usage period , '' the document reads .
