-LRB- CNN -RRB- -- Facebook has so many users -- more than a billion , or roughly the population of India -- that squeezing them all into one Web page seems almost impossible .
...
At first glance , the site looks like colorful , pixelated white noise . But users can zoom in to see individual photos and then scroll around or click on a photo to visit that person 's Facebook page . -LRB- Be warned , however : the page is experiencing heavy traffic and can be slow and buggy . -RRB-

The site launched last week and was built by Natalia Rojas , a self-described `` creative technologist '' in Barcelona , Spain .

`` I was playing around with Facebook API , and I discovered that there is a way to access everyone 's public information with a very simple -LRB- but not obvious -RRB- algorithm , '' she said in an e-mail to CNN . `` At that time , I thought I could do something beautiful/interesting with that , like showing them all together . Then I started to write the code to achieve it . ''

Rojas said she is not breaking Facebook privacy rules because she is not storing anyone 's name , photo or private information -- just linking out to public Facebook profiles . She also said she has n't heard from the social network , which she thinks is good news because `` I was a bit worried about things like using their name in the URL . ''
...
`` So I think , why do n't we try to BE our Facebook profile picture ? Even if life is difficult some times , there is always a way for us to be what we want to be : happy . ''
