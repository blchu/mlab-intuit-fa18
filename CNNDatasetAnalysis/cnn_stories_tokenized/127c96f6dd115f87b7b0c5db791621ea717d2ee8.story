-LRB- WIRED -RRB- -- From the results of the Pwn2Own hacking competition , it looks like Android and Windows Phone 7 are tough nuts to crack .
...
This year , Microsoft Internet Explorer 8 , Apple Safari 5.0.3 , Mozilla Firefox , and Google Chrome were the web-browser targets . In the mobile phone category , the Dell Venue Pro -LRB- Windows Phone 7 -RRB- , Apple iPhone 4 -LRB- iOS -RRB- , BlackBerry Torch 9800 -LRB- Blackberry 6 -RRB- and Nexus S -LRB- Android -RRB- were targeted .

The OS and browser versions were frozen last week -LRB- so for example , Apple 's Safari 5.0.4 update was not used -RRB- , ensuring that all contestants are working on the same version of each OS .
...
Charlie Miller , a Pwn2Own veteran , worked with Dion Blazakis to hack the iPhone 4 in this year 's competition using a flaw in its Mobile Safari Web browser and a `` specially-crafted webpage . '' A team of 3 -LRB- Vincenzo Iozzo , Willem Pinckaers , and Ralf Philipp Weinmenn -RRB- defeated the BlackBerry Torch using a similar technique .
...
Although no device is unhackable , some factors contribute to a safer product . For those that are out to find the safest phone on the market , Vreugdenhil says you 'll want to compare features such as DEP -LRB- Data Execution Prevention -RRB- , ASLR -LRB- address space layout randomization -RRB- , Sandboxing , code signing and the ease with which software can be updated on the device .
