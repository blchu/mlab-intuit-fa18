-LRB- CNN -RRB- -- On the same day that President Barack Obama spoke to the press about possible surveillance reforms -- and released a related white paper on the subject -- the National Security Agency came out with its own rare , publicly-released , seven-page document -LRB- PDF -RRB- , essentially justifying its own practices .
